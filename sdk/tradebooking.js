...
export class TradeBooking extends ClientSDK {
    ...
    async createTrade(tradeCreate, accountId, options) {
        return unwrapAsync(tradeBookingCreateTrade(this, tradeCreate, accountId, options));
    }
    /**
     * Get Trade
     *
    ...
    async getTrade(accountId, tradeId, options) {
        return unwrapAsync(tradeBookingGetTrade(this, accountId, tradeId, options));
    }
    /**
     * Complete Trade
     *
    ...
    async completeTrade(completeTradeRequestCreate, accountId, tradeId, options) {
        return unwrapAsync(tradeBookingCompleteTrade(this, completeTradeRequestCreate, accountId, tradeId, options));
    }
    /**
     * Cancel Trade
     *
    ...
    async cancelTrade(cancelTradeRequestCreate, accountId, tradeId, options) {
        return unwrapAsync(tradeBookingCancelTrade(this, cancelTradeRequestCreate, accountId, tradeId, options));
    }
    /**
     * Rebook Trade
     *
    ...
    async rebookTrade(rebookTradeRequestCreate, accountId, tradeId, options) {
        return unwrapAsync(tradeBookingRebookTrade(this, rebookTradeRequestCreate, accountId, tradeId, options));
    }
    /**
     * Create Execution
     *
    ...
    async createExecution(executionCreate, accountId, tradeId, options) {
        return unwrapAsync(tradeBookingCreateExecution(this, executionCreate, accountId, tradeId, options));
    }
    /**
     * Get Execution
     *
    ...
    async getExecution(accountId, tradeId, executionId, options) {
        return unwrapAsync(tradeBookingGetExecution(this, accountId, tradeId, executionId, options));
    }
    /**
     * Cancel Execution
     *
    ...
    async cancelExecution(cancelExecutionRequestCreate, accountId, tradeId, executionId, options) {
        return unwrapAsync(tradeBookingCancelExecution(this, cancelExecutionRequestCreate, accountId, tradeId, executionId, options));
    }
    /**
     * Rebook Execution
     *
    ...
    async rebookExecution(rebookExecutionRequestCreate, accountId, tradeId, executionId, options) {
        return unwrapAsync(tradeBookingRebookExecution(this, rebookExecutionRequestCreate, accountId, tradeId, executionId, options));
    }
}
