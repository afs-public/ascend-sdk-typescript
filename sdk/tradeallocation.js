...
export class TradeAllocation extends ClientSDK {
    ...
    async createTradeAllocation(tradeAllocationCreate, accountId, requestId, options) {
        return unwrapAsync(tradeAllocationCreateTradeAllocation(this, tradeAllocationCreate, accountId, requestId, options));
    }
    /**
    ...
    async getTradeAllocation(accountId, tradeAllocationId, options) {
        return unwrapAsync(tradeAllocationGetTradeAllocation(this, accountId, tradeAllocationId, options));
    }
    /**
    ...
    async cancelTradeAllocation(cancelTradeAllocationRequestCreate, accountId, tradeAllocationId, options) {
        return unwrapAsync(tradeAllocationCancelTradeAllocation(this, cancelTradeAllocationRequestCreate, accountId, tradeAllocationId, options));
    }
    /**
    ...
    async rebookTradeAllocation(rebookTradeAllocationRequestCreate, accountId, tradeAllocationId, options) {
        return unwrapAsync(tradeAllocationRebookTradeAllocation(this, rebookTradeAllocationRequestCreate, accountId, tradeAllocationId, options));
    }
}
