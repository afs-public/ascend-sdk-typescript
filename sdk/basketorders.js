...
export class BasketOrders extends ClientSDK {
    ...
    async createBasket(basketCreate, correspondentId, options) {
        return unwrapAsync(basketOrdersCreateBasket(this, basketCreate, correspondentId, options));
    }
    /**
     * Add Orders
     *
    ...
    async listBasketOrders(request, options) {
        return unwrapResultIterator(basketOrdersListBasketOrders(this, request, options));
    }
    /**
    ...
    async listCompressedOrders(correspondentId, basketId, pageSize, pageToken, options) {
        return unwrapResultIterator(basketOrdersListCompressedOrders(this, correspondentId, basketId, pageSize, pageToken, options));
    }
    /**
