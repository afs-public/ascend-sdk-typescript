...
export class CreateOrder extends ClientSDK {
    ...
    async createOrder(orderCreate, accountId, options) {
        return unwrapAsync(createOrderCreateOrder(this, orderCreate, accountId, options));
    }
    /**
     * Get Order
     *
    ...
    async getOrder(accountId, orderId, options) {
        return unwrapAsync(createOrderGetOrder(this, accountId, orderId, options));
    }
    /**
     * Cancel Order
     *
    ...
    async cancelOrder(cancelOrderRequestCreate, accountId, orderId, options) {
        return unwrapAsync(createOrderCancelOrder(this, cancelOrderRequestCreate, accountId, orderId, options));
    }
    /**
    ...
    async setExtraReportingData(setExtraReportingDataRequestCreate, accountId, orderId, options) {
        return unwrapAsync(createOrderSetExtraReportingData(this, setExtraReportingDataRequestCreate, accountId, orderId, options));
    }
    /**
    ...
    async listCorrespondentOrders(correspondentId, filter, pageSize, pageToken, options) {
        return unwrapAsync(createOrderListCorrespondentOrders(this, correspondentId, filter, pageSize, pageToken, options));
    }
}
