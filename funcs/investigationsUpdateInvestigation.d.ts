 ...
 */
export declare function investigationsUpdateInvestigation(client: ApexascendCore, investigationUpdate: components.InvestigationUpdate, investigationId: string, updateMask?: string | undefined, options?: RequestOptions): APIPromise<Result<operations.InvestigationServiceUpdateInvestigationResponse, errors.Status | ApexascendError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
