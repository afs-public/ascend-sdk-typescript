 ...
 */
export declare function subscriberDeletePushSubscription(client: ApexascendCore, subscriptionId: string, options?: RequestOptions): APIPromise<Result<operations.SubscriberDeletePushSubscriptionResponse, errors.Status | ApexascendError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
