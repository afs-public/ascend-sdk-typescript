 ...
 */
export declare function testSimulationForceRejectIctWithdrawal(client: ApexascendCore, forceRejectIctWithdrawalRequestCreate: components.ForceRejectIctWithdrawalRequestCreate, accountId: string, ictWithdrawalId: string, options?: RequestOptions): APIPromise<Result<operations.IctWithdrawalsForceRejectIctWithdrawalResponse, errors.Status | ApexascendError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
