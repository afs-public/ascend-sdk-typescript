 ...
 */
export declare function ordersSetExtraReportingData(client: ApexascendCore, setExtraReportingDataRequestCreate: components.SetExtraReportingDataRequestCreate, accountId: string, orderId: string, options?: RequestOptions): APIPromise<Result<operations.OrderServiceSetExtraReportingDataResponse, errors.Status | ApexascendError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
//# sourceMappingURL=ordersSetExtraReportingData.d.ts.map