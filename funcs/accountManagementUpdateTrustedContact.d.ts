 ...
 */
export declare function accountManagementUpdateTrustedContact(client: ApexascendCore, trustedContactUpdate: components.TrustedContactUpdate, accountId: string, trustedContactId: string, updateMask?: string | undefined, options?: RequestOptions): APIPromise<Result<operations.AccountsUpdateTrustedContactResponse, errors.Status | ApexascendError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
