 ...
 */
export declare function testSimulationForceApproveIctWithdrawal(client: ApexascendCore, forceApproveIctWithdrawalRequestCreate: components.ForceApproveIctWithdrawalRequestCreate, accountId: string, ictWithdrawalId: string, options?: RequestOptions): APIPromise<Result<operations.IctWithdrawalsForceApproveIctWithdrawalResponse, errors.Status | ApexascendError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
