 ...
 */
export declare function journalsCheckPartyType(client: ApexascendCore, request: components.CheckPartyTypeRequestCreate, options?: RequestOptions): APIPromise<Result<operations.CashJournalsCheckPartyTypeResponse, errors.Status | ApexascendError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
