 ...
 */
export declare function scheduleTransfersGetAchDepositSchedule(client: ApexascendCore, accountId: string, achDepositScheduleId: string, options?: RequestOptions): APIPromise<Result<operations.AchDepositSchedulesGetAchDepositScheduleResponse, errors.Status | ApexascendError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
