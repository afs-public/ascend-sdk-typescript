 ...
 */
export declare function bankRelationshipsCreateBankRelationship(client: ApexascendCore, bankRelationshipCreate: components.BankRelationshipCreate, accountId: string, options?: RequestOptions): APIPromise<Result<operations.BankRelationshipsCreateBankRelationshipResponse, errors.Status | ApexascendError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
