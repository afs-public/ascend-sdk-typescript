 ...
 */
export declare function accountManagementCreateInterestedParty(client: ApexascendCore, interestedPartyCreate: components.InterestedPartyCreate, accountId: string, options?: RequestOptions): APIPromise<Result<operations.AccountsCreateInterestedPartyResponse, errors.Status | ApexascendError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
