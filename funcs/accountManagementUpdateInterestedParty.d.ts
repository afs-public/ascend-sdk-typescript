 ...
 */
export declare function accountManagementUpdateInterestedParty(client: ApexascendCore, interestedPartyUpdate: components.InterestedPartyUpdate, accountId: string, interestedPartyId: string, updateMask?: string | undefined, options?: RequestOptions): APIPromise<Result<operations.AccountsUpdateInterestedPartyResponse, errors.Status | ApexascendError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
