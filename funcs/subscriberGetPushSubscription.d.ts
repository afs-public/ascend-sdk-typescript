 ...
 */
export declare function subscriberGetPushSubscription(client: ApexascendCore, subscriptionId: string, options?: RequestOptions): APIPromise<Result<operations.SubscriberGetPushSubscriptionResponse, errors.Status | ApexascendError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
