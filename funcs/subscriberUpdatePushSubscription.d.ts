 ...
 */
export declare function subscriberUpdatePushSubscription(client: ApexascendCore, pushSubscriptionUpdate: components.PushSubscriptionUpdate, subscriptionId: string, updateMask?: string | undefined, options?: RequestOptions): APIPromise<Result<operations.SubscriberUpdatePushSubscriptionResponse, errors.Status | ApexascendError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
