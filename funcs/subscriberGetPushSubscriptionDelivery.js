 ...
 */
export function subscriberGetPushSubscriptionDelivery(client, subscriptionId, deliveryId, options) {
    return new APIPromise($do(client, subscriptionId, deliveryId, options));
}
async function $do(client, subscriptionId, deliveryId, options) {
    ...
    const parsed = safeParse(input, (value) => operations.SubscriberGetPushSubscriptionDeliveryRequest$outboundSchema
    ...
    const path = pathToFunc("/events/v1/subscriptions/{subscription_id}/deliveries/{delivery_id}")(pathParams);
