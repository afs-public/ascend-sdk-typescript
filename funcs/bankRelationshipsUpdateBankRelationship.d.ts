 ...
 */
export declare function bankRelationshipsUpdateBankRelationship(client: ApexascendCore, bankRelationshipUpdate: components.BankRelationshipUpdate, accountId: string, bankRelationshipId: string, updateMask?: string | undefined, options?: RequestOptions): APIPromise<Result<operations.BankRelationshipsUpdateBankRelationshipResponse, errors.Status | ApexascendError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
