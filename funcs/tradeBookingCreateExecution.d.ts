 ...
 */
export declare function tradeBookingCreateExecution(client: ApexascendCore, executionCreate: components.ExecutionCreate, accountId: string, tradeId: string, options?: RequestOptions): APIPromise<Result<operations.BookingCreateExecutionResponse, errors.Status | ApexascendError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
