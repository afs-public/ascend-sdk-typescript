 ...
 */
export declare function testSimulationForceRejectAchDeposit(client: ApexascendCore, forceRejectAchDepositRequestCreate: components.ForceRejectAchDepositRequestCreate, accountId: string, achDepositId: string, options?: RequestOptions): APIPromise<Result<operations.AchDepositsForceRejectAchDepositResponse, errors.Status | ApexascendError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
