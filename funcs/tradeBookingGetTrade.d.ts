 ...
 */
export declare function tradeBookingGetTrade(client: ApexascendCore, accountId: string, tradeId: string, options?: RequestOptions): APIPromise<Result<operations.BookingGetTradeResponse, errors.Status | ApexascendError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
