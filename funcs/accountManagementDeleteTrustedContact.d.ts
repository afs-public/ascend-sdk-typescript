 ...
 */
export declare function accountManagementDeleteTrustedContact(client: ApexascendCore, accountId: string, trustedContactId: string, options?: RequestOptions): APIPromise<Result<operations.AccountsDeleteTrustedContactResponse, errors.Status | ApexascendError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
