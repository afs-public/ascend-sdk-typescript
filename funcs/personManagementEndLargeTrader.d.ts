 ...
 */
export declare function personManagementEndLargeTrader(client: ApexascendCore, endLargeTraderRequestCreate: components.EndLargeTraderRequestCreate, legalEntityId: string, options?: RequestOptions): APIPromise<Result<operations.AccountsEndLargeTrader1Response, errors.Status | ApexascendError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
