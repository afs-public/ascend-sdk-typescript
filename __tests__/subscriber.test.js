...
(0, vitest_1.test)("Subscriber Subscriber List Push Subscriptions", async () => {
    const testHttpClient = (0, testclient_js_1.createTestHTTPClient)("Subscriber_ListPushSubscriptions");
