...
/** @internal */
exports.LotTradeDate$outboundSchema = z.object({
    day: z.number().int().optional(),
    month: z.number().int().optional(),
    year: z.number().int().optional(),
});
...
(function (LotTradeDate$) {
    ...
    LotTradeDate$.inboundSchema = exports.LotTradeDate$inboundSchema;
...
exports.Lot$inboundSchema = z
    ...
    trade_date: z.nullable(z.lazy(() => exports.LotTradeDate$inboundSchema)).optional(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
...
exports.Lot$outboundSchema = z
    ...
    tradeDate: z.nullable(z.lazy(() => exports.LotTradeDate$outboundSchema)).optional(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
