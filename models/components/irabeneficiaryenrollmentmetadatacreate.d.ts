...
export declare function iraBeneficiaryEnrollmentMetadataCreateToJSON(iraBeneficiaryEnrollmentMetadataCreate: IRABeneficiaryEnrollmentMetadataCreate): string;
export declare function iraBeneficiaryEnrollmentMetadataCreateFromJSON(jsonString: string): SafeParseResult<IRABeneficiaryEnrollmentMetadataCreate, SDKValidationError>;
