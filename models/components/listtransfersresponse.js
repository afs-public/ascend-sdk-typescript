...
exports.ListTransfersResponse$inboundSchema = z.object({
    ...
    transfers: z.array(acatstransfer_js_1.AcatsTransfer$inboundSchema).optional(),
}).transform((v) => {
...
/** @internal */
exports.ListTransfersResponse$outboundSchema = z.object({
    nextPageToken: z.string().optional(),
    transfers: z.array(acatstransfer_js_1.AcatsTransfer$outboundSchema).optional(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
 ...
 */
var ListTransfersResponse$;
(function (ListTransfersResponse$) {
    /** @deprecated use `ListTransfersResponse$inboundSchema` instead. */
    ListTransfersResponse$.inboundSchema = exports.ListTransfersResponse$inboundSchema;
