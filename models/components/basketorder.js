...
var BasketOrderSpecialReportingInstructions;
...
})(BasketOrderSpecialReportingInstructions || (exports.BasketOrderSpecialReportingInstructions = BasketOrderSpecialReportingInstructions = {}));
/**
...
/** @internal */
exports.BasketOrderSpecialReportingInstructions$inboundSchema = z
    .union([
    z.nativeEnum(BasketOrderSpecialReportingInstructions),
    z.string().transform(enums_js_1.catchUnrecognizedEnum),
]);
/** @internal */
exports.BasketOrderSpecialReportingInstructions$outboundSchema = z.union([
    z.nativeEnum(BasketOrderSpecialReportingInstructions),
    z.string().and(z.custom()),
]);
/**
...
(function (BasketOrderSpecialReportingInstructions$) {
    ...
    BasketOrderSpecialReportingInstructions$.inboundSchema = exports.BasketOrderSpecialReportingInstructions$inboundSchema;
    /** @deprecated use `BasketOrderSpecialReportingInstructions$outboundSchema` instead. */
    BasketOrderSpecialReportingInstructions$.outboundSchema = exports.BasketOrderSpecialReportingInstructions$outboundSchema;
})(BasketOrderSpecialReportingInstructions$ || (exports.BasketOrderSpecialReportingInstructions$ = BasketOrderSpecialReportingInstructions$ = {}));
/** @internal */
...
exports.BasketOrder$inboundSchema = z.object({
    ...
    special_reporting_instructions: z.array(exports.BasketOrderSpecialReportingInstructions$inboundSchema).optional(),
...
exports.BasketOrder$outboundSchema = z.object({
    ...
    specialReportingInstructions: z.array(exports.BasketOrderSpecialReportingInstructions$outboundSchema).optional(),
