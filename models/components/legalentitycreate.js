...
var BusinessIndustrialClassification;
...
})(BusinessIndustrialClassification || (exports.BusinessIndustrialClassification = BusinessIndustrialClassification = {}));
/**
 * Corporate structure of the entity.
 */
var CorporateStructure;
...
})(CorporateStructure || (exports.CorporateStructure = CorporateStructure = {}));
/**
 * The entity type.
 */
var EntityType;
...
})(ExemptCustomerReason || (exports.ExemptCustomerReason = ExemptCustomerReason = {}));
/**
 * The nature of the U.S. Tax ID indicated in the related tax_id field; Examples include ITIN, SSN, EIN.
 */
var LegalEntityCreateTaxIdType;
...
})(LegalEntityCreateTaxIdType || (exports.LegalEntityCreateTaxIdType = LegalEntityCreateTaxIdType = {}));
/** @internal */
exports.BusinessIndustrialClassification$inboundSchema = z
    .union([
    z.nativeEnum(BusinessIndustrialClassification),
    z.string().transform(enums_js_1.catchUnrecognizedEnum),
]);
/** @internal */
exports.BusinessIndustrialClassification$outboundSchema = z.union([
    z.nativeEnum(BusinessIndustrialClassification),
...
(function (BusinessIndustrialClassification$) {
    ...
    BusinessIndustrialClassification$.inboundSchema = exports.BusinessIndustrialClassification$inboundSchema;
    /** @deprecated use `BusinessIndustrialClassification$outboundSchema` instead. */
    BusinessIndustrialClassification$.outboundSchema = exports.BusinessIndustrialClassification$outboundSchema;
})(BusinessIndustrialClassification$ || (exports.BusinessIndustrialClassification$ = BusinessIndustrialClassification$ = {}));
/** @internal */
exports.CorporateStructure$inboundSchema = z
    .union([
    z.nativeEnum(CorporateStructure),
    z.string().transform(enums_js_1.catchUnrecognizedEnum),
]);
/** @internal */
exports.CorporateStructure$outboundSchema = z.union([
    z.nativeEnum(CorporateStructure),
    z.string().and(z.custom()),
]);
/**
...
(function (CorporateStructure$) {
    ...
    CorporateStructure$.inboundSchema = exports.CorporateStructure$inboundSchema;
    /** @deprecated use `CorporateStructure$outboundSchema` instead. */
    CorporateStructure$.outboundSchema = exports.CorporateStructure$outboundSchema;
})(CorporateStructure$ || (exports.CorporateStructure$ = CorporateStructure$ = {}));
/** @internal */
...
/** @internal */
exports.ExemptCustomerReason$inboundSchema = z
    .union([
    z.nativeEnum(ExemptCustomerReason),
    z.string().transform(enums_js_1.catchUnrecognizedEnum),
]);
/** @internal */
exports.ExemptCustomerReason$outboundSchema = z.union([
    z.nativeEnum(ExemptCustomerReason),
    z.string().and(z.custom()),
]);
/**
...
(function (ExemptCustomerReason$) {
    ...
    ExemptCustomerReason$.inboundSchema = exports.ExemptCustomerReason$inboundSchema;
    /** @deprecated use `ExemptCustomerReason$outboundSchema` instead. */
    ExemptCustomerReason$.outboundSchema = exports.ExemptCustomerReason$outboundSchema;
})(ExemptCustomerReason$ || (exports.ExemptCustomerReason$ = ExemptCustomerReason$ = {}));
/** @internal */
exports.LegalEntityCreateTaxIdType$inboundSchema = z
    .union([
    z.nativeEnum(LegalEntityCreateTaxIdType),
    z.string().transform(enums_js_1.catchUnrecognizedEnum),
]);
/** @internal */
exports.LegalEntityCreateTaxIdType$outboundSchema = z.union([
    z.nativeEnum(LegalEntityCreateTaxIdType),
    z.string().and(z.custom()),
]);
/**
...
(function (LegalEntityCreateTaxIdType$) {
    ...
    LegalEntityCreateTaxIdType$.inboundSchema = exports.LegalEntityCreateTaxIdType$inboundSchema;
    /** @deprecated use `LegalEntityCreateTaxIdType$outboundSchema` instead. */
    LegalEntityCreateTaxIdType$.outboundSchema = exports.LegalEntityCreateTaxIdType$outboundSchema;
})(LegalEntityCreateTaxIdType$ || (exports.LegalEntityCreateTaxIdType$ = LegalEntityCreateTaxIdType$ = {}));
/** @internal */
exports.LegalEntityCreate$inboundSchema = z.object({
    accredited_investor: z.boolean().optional(),
    adviser: z.boolean().optional(),
    broker_dealer: z.boolean().optional(),
    business_industrial_classification: exports.BusinessIndustrialClassification$inboundSchema.optional(),
    corporate_structure: exports.CorporateStructure$inboundSchema.optional(),
    correspondent_id: z.string(),
    doing_business_as: z.array(z.string()).optional(),
    entity_due_diligence: entityduediligencecreate_js_1.EntityDueDiligenceCreate$inboundSchema.optional(),
    entity_name: z.string(),
    entity_type: exports.EntityType$inboundSchema,
    exempt_customer_reason: exports.ExemptCustomerReason$inboundSchema.optional(),
    ...
    formation_date: datecreate_js_1.DateCreate$inboundSchema.optional(),
    institutional_customer: z.boolean().optional(),
    large_trader: largetradercreate_js_1.LargeTraderCreate$inboundSchema.optional(),
    legal_address: postaladdresscreate_js_1.PostalAddressCreate$inboundSchema,
    ...
    tax_id: z.string(),
    tax_id_type: exports.LegalEntityCreateTaxIdType$inboundSchema,
...
/** @internal */
exports.LegalEntityCreate$outboundSchema = z.object({
    accreditedInvestor: z.boolean().optional(),
    adviser: z.boolean().optional(),
    brokerDealer: z.boolean().optional(),
    businessIndustrialClassification: exports.BusinessIndustrialClassification$outboundSchema.optional(),
    corporateStructure: exports.CorporateStructure$outboundSchema.optional(),
    correspondentId: z.string(),
    doingBusinessAs: z.array(z.string()).optional(),
    entityDueDiligence: entityduediligencecreate_js_1.EntityDueDiligenceCreate$outboundSchema.optional(),
    entityName: z.string(),
    entityType: exports.EntityType$outboundSchema,
    exemptCustomerReason: exports.ExemptCustomerReason$outboundSchema.optional(),
    ...
    formationDate: datecreate_js_1.DateCreate$outboundSchema.optional(),
    institutionalCustomer: z.boolean().optional(),
    largeTrader: largetradercreate_js_1.LargeTraderCreate$outboundSchema.optional(),
    legalAddress: postaladdresscreate_js_1.PostalAddressCreate$outboundSchema,
    ...
    taxId: z.string(),
    taxIdType: exports.LegalEntityCreateTaxIdType$outboundSchema,
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var LegalEntityCreate$;
(function (LegalEntityCreate$) {
    /** @deprecated use `LegalEntityCreate$inboundSchema` instead. */
    LegalEntityCreate$.inboundSchema = exports.LegalEntityCreate$inboundSchema;
