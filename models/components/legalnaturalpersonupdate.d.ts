...
export declare function legalNaturalPersonUpdateToJSON(legalNaturalPersonUpdate: LegalNaturalPersonUpdate): string;
export declare function legalNaturalPersonUpdateFromJSON(jsonString: string): SafeParseResult<LegalNaturalPersonUpdate, SDKValidationError>;
