...
export declare function jointTenantsByEntiretyEnrollmentMetadataCreateToJSON(jointTenantsByEntiretyEnrollmentMetadataCreate: JointTenantsByEntiretyEnrollmentMetadataCreate): string;
export declare function jointTenantsByEntiretyEnrollmentMetadataCreateFromJSON(jsonString: string): SafeParseResult<JointTenantsByEntiretyEnrollmentMetadataCreate, SDKValidationError>;
