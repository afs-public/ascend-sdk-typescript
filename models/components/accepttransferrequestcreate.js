...
/** @internal */
exports.AcceptTransferRequestCreate$outboundSchema = z.object({
    comment: z.string().optional(),
    name: z.string(),
});
/**
 ...
 */
var AcceptTransferRequestCreate$;
(function (AcceptTransferRequestCreate$) {
    /** @deprecated use `AcceptTransferRequestCreate$inboundSchema` instead. */
    AcceptTransferRequestCreate$.inboundSchema = exports.AcceptTransferRequestCreate$inboundSchema;
