...
/** @internal */
exports.TradeAllocationSettlementDate$outboundSchema = z.object({
    day: z.number().int().optional(),
    month: z.number().int().optional(),
    year: z.number().int().optional(),
});
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var TradeAllocationSettlementDate$;
(function (TradeAllocationSettlementDate$) {
    /** @deprecated use `TradeAllocationSettlementDate$inboundSchema` instead. */
    TradeAllocationSettlementDate$.inboundSchema = exports.TradeAllocationSettlementDate$inboundSchema;
...
exports.TradeAllocation$inboundSchema = z.object({
    ...
    quantity: z.nullable(z.lazy(() => exports.TradeAllocationQuantity$inboundSchema))
        .optional(),
    settlement_date: z.nullable(z.lazy(() => exports.TradeAllocationSettlementDate$inboundSchema)).optional(),
...
exports.TradeAllocation$outboundSchema = z.object({
    ...
    quantity: z.nullable(z.lazy(() => exports.TradeAllocationQuantity$outboundSchema))
        .optional(),
    settlementDate: z.nullable(z.lazy(() => exports.TradeAllocationSettlementDate$outboundSchema)).optional(),
