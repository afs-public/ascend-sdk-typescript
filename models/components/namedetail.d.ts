...
export declare function nameDetailToJSON(nameDetail: NameDetail): string;
export declare function nameDetailFromJSON(jsonString: string): SafeParseResult<NameDetail, SDKValidationError>;
