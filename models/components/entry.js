...
exports.Entry$ = exports.Entry$outboundSchema = exports.Entry$inboundSchema = void 0;
exports.acatsPendingOutToJSON = acatsPendingOutToJSON;
exports.acatsPendingOutFromJSON = acatsPendingOutFromJSON;
exports.fairMarketValueToJSON = fairMarketValueToJSON;
exports.fairMarketValueFromJSON = fairMarketValueFromJSON;
exports.fairMarketValueDateToJSON = fairMarketValueDateToJSON;
exports.fairMarketValueDateFromJSON = fairMarketValueDateFromJSON;
...
})(AccountTransferType || (exports.AccountTransferType = AccountTransferType = {}));
/**
...
})(TenderOfferType || (exports.TenderOfferType = TenderOfferType = {}));
/**
 * Used to calculate broadridge blotter code
 */
var EntryTradeBrokerCapacity;
...
})(EntryTradeBrokerCapacity || (exports.EntryTradeBrokerCapacity = EntryTradeBrokerCapacity = {}));
/**
 * The type of price adjustment being applied by the broker to the net price of the security
 */
var EntryTradePriceAdjustmentType;
...
})(EntryTradePriceAdjustmentType || (exports.EntryTradePriceAdjustmentType = EntryTradePriceAdjustmentType = {}));
/**
...
/** @internal */
exports.AccountTransferType$inboundSchema = z
    .union([
    z.nativeEnum(AccountTransferType),
    z.string().transform(enums_js_1.catchUnrecognizedEnum),
]);
/** @internal */
exports.AccountTransferType$outboundSchema = z.union([
    z.nativeEnum(AccountTransferType),
    z.string().and(z.custom()),
]);
/**
...
(function (AccountTransferType$) {
    ...
    AccountTransferType$.inboundSchema = exports.AccountTransferType$inboundSchema;
    /** @deprecated use `AccountTransferType$outboundSchema` instead. */
    AccountTransferType$.outboundSchema = exports.AccountTransferType$outboundSchema;
})(AccountTransferType$ || (exports.AccountTransferType$ = AccountTransferType$ = {}));
/** @internal */
...
/** @internal */
exports.FairMarketValue$inboundSchema = z.object({
    value: z.string().optional(),
});
/** @internal */
exports.FairMarketValue$outboundSchema = z.object({
    value: z.string().optional(),
});
/**
 * @internal
...
(function (FairMarketValue$) {
    ...
    FairMarketValue$.inboundSchema = exports.FairMarketValue$inboundSchema;
    /** @deprecated use `FairMarketValue$outboundSchema` instead. */
    FairMarketValue$.outboundSchema = exports.FairMarketValue$outboundSchema;
})(FairMarketValue$ || (exports.FairMarketValue$ = FairMarketValue$ = {}));
function fairMarketValueToJSON(fairMarketValue) {
    return JSON.stringify(exports.FairMarketValue$outboundSchema.parse(fairMarketValue));
}
function fairMarketValueFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.FairMarketValue$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'FairMarketValue' from JSON`);
}
/** @internal */
exports.FairMarketValueDate$inboundSchema = z.object({
    day: z.number().int().optional(),
    month: z.number().int().optional(),
    year: z.number().int().optional(),
});
/** @internal */
exports.FairMarketValueDate$outboundSchema = z.object({
    day: z.number().int().optional(),
    month: z.number().int().optional(),
    year: z.number().int().optional(),
});
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var FairMarketValueDate$;
(function (FairMarketValueDate$) {
    /** @deprecated use `FairMarketValueDate$inboundSchema` instead. */
    FairMarketValueDate$.inboundSchema = exports.FairMarketValueDate$inboundSchema;
    /** @deprecated use `FairMarketValueDate$outboundSchema` instead. */
    FairMarketValueDate$.outboundSchema = exports.FairMarketValueDate$outboundSchema;
})(FairMarketValueDate$ || (exports.FairMarketValueDate$ = FairMarketValueDate$ = {}));
function fairMarketValueDateToJSON(fairMarketValueDate) {
    return JSON.stringify(exports.FairMarketValueDate$outboundSchema.parse(fairMarketValueDate));
}
function fairMarketValueDateFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.FairMarketValueDate$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'FairMarketValueDate' from JSON`);
}
/** @internal */
...
exports.AccountTransfer$inboundSchema = z.object({
    ...
    acats_control_number: z.string().optional(),
    account_transfer_type: exports.AccountTransferType$inboundSchema.optional(),
    ...
    fair_market_value: z.nullable(z.lazy(() => exports.FairMarketValue$inboundSchema))
        .optional(),
    fair_market_value_date: z.nullable(z.lazy(() => exports.FairMarketValueDate$inboundSchema)).optional(),
...
exports.AccountTransfer$outboundSchema = z.object({
    ...
    acatsControlNumber: z.string().optional(),
    accountTransferType: exports.AccountTransferType$outboundSchema.optional(),
    action: exports.Action$outboundSchema.optional(),
    additionalInstructions: z.string().optional(),
    contraPartyAccountNumber: z.string().optional(),
    contraPartyId: z.string().optional(),
    fairMarketValue: z.nullable(z.lazy(() => exports.FairMarketValue$outboundSchema))
        .optional(),
    fairMarketValueDate: z.nullable(z.lazy(() => exports.FairMarketValueDate$outboundSchema)).optional(),
    institution: z.string().optional(),
...
/** @internal */
exports.PriceAdjustmentPercent$outboundSchema = z.object({
    value: z.string().optional(),
});
/**
 * @internal
...
(function (PriceAdjustmentPercent$) {
    ...
    PriceAdjustmentPercent$.inboundSchema = exports.PriceAdjustmentPercent$inboundSchema;
...
/** @internal */
exports.PriceAdjustmentRecord$inboundSchema = z.object({
    price_adjustment_amount: z.nullable(z.lazy(() => exports.EntryPriceAdjustmentAmount$inboundSchema)).optional(),
    price_adjustment_percent: z.nullable(z.lazy(() => exports.PriceAdjustmentPercent$inboundSchema)).optional(),
...
/** @internal */
exports.PriceAdjustmentRecord$outboundSchema = z.object({
    priceAdjustmentAmount: z.nullable(z.lazy(() => exports.EntryPriceAdjustmentAmount$outboundSchema)).optional(),
    priceAdjustmentPercent: z.nullable(z.lazy(() => exports.PriceAdjustmentPercent$outboundSchema)).optional(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var PriceAdjustmentRecord$;
(function (PriceAdjustmentRecord$) {
    /** @deprecated use `PriceAdjustmentRecord$inboundSchema` instead. */
    PriceAdjustmentRecord$.inboundSchema = exports.PriceAdjustmentRecord$inboundSchema;
...
exports.Allocation$inboundSchema = z.object({
    ...
    price_adjustment_record: z.nullable(z.lazy(() => exports.PriceAdjustmentRecord$inboundSchema)).optional(),
...
exports.Allocation$outboundSchema = z.object({
    ...
    priceAdjustmentRecord: z.nullable(z.lazy(() => exports.PriceAdjustmentRecord$outboundSchema)).optional(),
...
/** @internal */
exports.EntryBondDefaultQuantity$outboundSchema = z.object({
    value: z.string().optional(),
});
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var EntryBondDefaultQuantity$;
(function (EntryBondDefaultQuantity$) {
    /** @deprecated use `EntryBondDefaultQuantity$inboundSchema` instead. */
    EntryBondDefaultQuantity$.inboundSchema = exports.EntryBondDefaultQuantity$inboundSchema;
...
exports.BondDefault$inboundSchema = z.object({
    ...
    quantity: z.nullable(z.lazy(() => exports.EntryBondDefaultQuantity$inboundSchema))
        .optional(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
        "cash_rate": "cashRate",
...
/** @internal */
exports.BondDefault$outboundSchema = z.object({
    ...
    quantity: z.nullable(z.lazy(() => exports.EntryBondDefaultQuantity$outboundSchema))
        .optional(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
        cashRate: "cash_rate",
...
(function (BondDefault$) {
    ...
    BondDefault$.inboundSchema = exports.BondDefault$inboundSchema;
...
/** @internal */
exports.EntryCapitalGainsCorporateActionGeneralInformation$outboundSchema = z.object({
    corporateActionId: z.string().optional(),
    disbursedAssetId: z.string().optional(),
    disbursedCusip: z.string().optional(),
    disbursedSymbolDescription: z.string().optional(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var EntryCapitalGainsCorporateActionGeneralInformation$;
(function (EntryCapitalGainsCorporateActionGeneralInformation$) {
    ...
    EntryCapitalGainsCorporateActionGeneralInformation$.inboundSchema = exports.EntryCapitalGainsCorporateActionGeneralInformation$inboundSchema;
...
exports.CapitalGains$inboundSchema = z.object({
    ...
    corporate_action_general_information: z.nullable(z.lazy(() => exports.EntryCapitalGainsCorporateActionGeneralInformation$inboundSchema)).optional(),
...
exports.CapitalGains$outboundSchema = z.object({
    ...
    corporateActionGeneralInformation: z.nullable(z.lazy(() => exports.EntryCapitalGainsCorporateActionGeneralInformation$outboundSchema)).optional(),
...
/** @internal */
exports.EntryCashDividendCashRate$outboundSchema = z.object({
    value: z.string().optional(),
});
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var EntryCashDividendCashRate$;
(function (EntryCashDividendCashRate$) {
    /** @deprecated use `EntryCashDividendCashRate$inboundSchema` instead. */
    EntryCashDividendCashRate$.inboundSchema = exports.EntryCashDividendCashRate$inboundSchema;
...
/** @internal */
exports.EntryCashDividendPaymentDate$outboundSchema = z.object({
    day: z.number().int().optional(),
    month: z.number().int().optional(),
    year: z.number().int().optional(),
});
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var EntryCashDividendPaymentDate$;
(function (EntryCashDividendPaymentDate$) {
    /** @deprecated use `EntryCashDividendPaymentDate$inboundSchema` instead. */
    EntryCashDividendPaymentDate$.inboundSchema = exports.EntryCashDividendPaymentDate$inboundSchema;
...
exports.CashDividend$inboundSchema = z.object({
    cash_rate: z.nullable(z.lazy(() => exports.EntryCashDividendCashRate$inboundSchema))
        .optional(),
    ...
    long_term_gain: z.boolean().optional(),
    payment_date: z.nullable(z.lazy(() => exports.EntryCashDividendPaymentDate$inboundSchema)).optional(),
    qualified: z.boolean().optional(),
...
exports.CashDividend$outboundSchema = z.object({
    cashRate: z.nullable(z.lazy(() => exports.EntryCashDividendCashRate$outboundSchema))
        .optional(),
    ...
    longTermGain: z.boolean().optional(),
    paymentDate: z.nullable(z.lazy(() => exports.EntryCashDividendPaymentDate$outboundSchema)).optional(),
    qualified: z.boolean().optional(),
...
/** @internal */
exports.EntryCashInLieuCorporateActionGeneralInformation$outboundSchema = z.object({
    corporateActionId: z.string().optional(),
    disbursedAssetId: z.string().optional(),
    disbursedCusip: z.string().optional(),
    disbursedSymbolDescription: z.string().optional(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var EntryCashInLieuCorporateActionGeneralInformation$;
(function (EntryCashInLieuCorporateActionGeneralInformation$) {
    ...
    EntryCashInLieuCorporateActionGeneralInformation$.inboundSchema = exports.EntryCashInLieuCorporateActionGeneralInformation$inboundSchema;
...
/** @internal */
exports.CashInLieu$outboundSchema = z.object({
    corporateActionGeneralInformation: z.nullable(z.lazy(() => exports.EntryCashInLieuCorporateActionGeneralInformation$outboundSchema)).optional(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
        corporateActionGeneralInformation: "corporate_action_general_information",
    });
...
(function (CashInLieu$) {
    ...
    CashInLieu$.inboundSchema = exports.CashInLieu$inboundSchema;
...
/** @internal */
exports.TenderOfferType$outboundSchema = z.union([
    z.nativeEnum(TenderOfferType),
    z.string().and(z.custom()),
]);
/**
...
(function (TenderOfferType$) {
    ...
    TenderOfferType$.inboundSchema = exports.TenderOfferType$inboundSchema;
    /** @deprecated use `TenderOfferType$outboundSchema` instead. */
    TenderOfferType$.outboundSchema = exports.TenderOfferType$outboundSchema;
})(TenderOfferType$ || (exports.TenderOfferType$ = TenderOfferType$ = {}));
/** @internal */
exports.TenderOffer$inboundSchema = z.object({
    ...
    tender_offer_type: exports.TenderOfferType$inboundSchema.optional(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
        "cash_rate": "cashRate",
        "corporate_action_general_information": "corporateActionGeneralInformation",
...
exports.TenderOffer$outboundSchema = z.object({
    ...
    tenderOfferType: exports.TenderOfferType$outboundSchema.optional(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
        cashRate: "cash_rate",
        corporateActionGeneralInformation: "corporate_action_general_information",
...
/** @internal */
exports.EntryTradeBrokerCapacity$outboundSchema = z.union([
    z.nativeEnum(EntryTradeBrokerCapacity),
    z.string().and(z.custom()),
]);
/**
...
(function (EntryTradeBrokerCapacity$) {
    ...
    EntryTradeBrokerCapacity$.inboundSchema = exports.EntryTradeBrokerCapacity$inboundSchema;
    /** @deprecated use `EntryTradeBrokerCapacity$outboundSchema` instead. */
    EntryTradeBrokerCapacity$.outboundSchema = exports.EntryTradeBrokerCapacity$outboundSchema;
})(EntryTradeBrokerCapacity$ || (exports.EntryTradeBrokerCapacity$ = EntryTradeBrokerCapacity$ = {}));
/** @internal */
exports.EntryTradePrevailingMarketPrice$inboundSchema = z.object({
    value: z.string().optional(),
});
/** @internal */
exports.EntryTradePrevailingMarketPrice$outboundSchema = z.object({
    value: z.string().optional(),
});
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var EntryTradePrevailingMarketPrice$;
(function (EntryTradePrevailingMarketPrice$) {
    /** @deprecated use `EntryTradePrevailingMarketPrice$inboundSchema` instead. */
    EntryTradePrevailingMarketPrice$.inboundSchema = exports.EntryTradePrevailingMarketPrice$inboundSchema;
...
/** @internal */
exports.EntryTradePriceAdjustmentAmount$outboundSchema = z.object({
    value: z.string().optional(),
});
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var EntryTradePriceAdjustmentAmount$;
(function (EntryTradePriceAdjustmentAmount$) {
    /** @deprecated use `EntryTradePriceAdjustmentAmount$inboundSchema` instead. */
    EntryTradePriceAdjustmentAmount$.inboundSchema = exports.EntryTradePriceAdjustmentAmount$inboundSchema;
...
/** @internal */
exports.EntryTradePriceAdjustmentType$outboundSchema = z.union([
    z.nativeEnum(EntryTradePriceAdjustmentType),
    z.string().and(z.custom()),
]);
/**
...
(function (EntryTradePriceAdjustmentType$) {
    ...
    EntryTradePriceAdjustmentType$.inboundSchema = exports.EntryTradePriceAdjustmentType$inboundSchema;
    /** @deprecated use `EntryTradePriceAdjustmentType$outboundSchema` instead. */
    EntryTradePriceAdjustmentType$.outboundSchema = exports.EntryTradePriceAdjustmentType$outboundSchema;
})(EntryTradePriceAdjustmentType$ || (exports.EntryTradePriceAdjustmentType$ = EntryTradePriceAdjustmentType$ = {}));
/** @internal */
exports.EntryPriceAdjustmentRecord$inboundSchema = z.object({
    price_adjustment_amount: z.nullable(z.lazy(() => exports.EntryTradePriceAdjustmentAmount$inboundSchema)).optional(),
    price_adjustment_percent: z.nullable(z.lazy(() => exports.EntryPriceAdjustmentPercent$inboundSchema)).optional(),
    price_adjustment_type: exports.EntryTradePriceAdjustmentType$inboundSchema.optional(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
        "price_adjustment_amount": "priceAdjustmentAmount",
        "price_adjustment_percent": "priceAdjustmentPercent",
...
exports.EntryPriceAdjustmentRecord$outboundSchema = z.object({
    priceAdjustmentAmount: z.nullable(z.lazy(() => exports.EntryTradePriceAdjustmentAmount$outboundSchema)).optional(),
    priceAdjustmentPercent: z.nullable(z.lazy(() => exports.EntryPriceAdjustmentPercent$outboundSchema)).optional(),
    priceAdjustmentType: exports.EntryTradePriceAdjustmentType$outboundSchema.optional(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
        priceAdjustmentAmount: "price_adjustment_amount",
        priceAdjustmentPercent: "price_adjustment_percent",
...
exports.EntryTrade$inboundSchema = z.object({
    ...
    booking_api_trade_id: z.string().optional(),
    broker: z.string().optional(),
    broker_capacity: exports.EntryTradeBrokerCapacity$inboundSchema.optional(),
    client_memo: z.string().optional(),
    client_order_id: z.string().optional(),
    exchange: z.string().optional(),
    execution_id: z.string().optional(),
    ...
    market: z.string().optional(),
    order_id: z.string().optional(),
    prevailing_market_price: z.nullable(z.lazy(() => exports.EntryTradePrevailingMarketPrice$inboundSchema)).optional(),
...
exports.EntryTrade$outboundSchema = z.object({
    ...
    bookingApiTradeId: z.string().optional(),
    broker: z.string().optional(),
    brokerCapacity: exports.EntryTradeBrokerCapacity$outboundSchema.optional(),
    clientMemo: z.string().optional(),
    clientOrderId: z.string().optional(),
    exchange: z.string().optional(),
    executionId: z.string().optional(),
    ...
    market: z.string().optional(),
    orderId: z.string().optional(),
    prevailingMarketPrice: z.nullable(z.lazy(() => exports.EntryTradePrevailingMarketPrice$outboundSchema)).optional(),
...
/** @internal */
exports.EntryTransfer$inboundSchema = z.object({
    additional_instructions: z.string().optional(),
...
/** @internal */
exports.EntryTransfer$outboundSchema = z.object({
    additionalInstructions: z.string().optional(),
...
(function (EntryTransfer$) {
    ...
    EntryTransfer$.inboundSchema = exports.EntryTransfer$inboundSchema;
...
exports.Entry$inboundSchema = z
    ...
    allocation: z.nullable(z.lazy(() => exports.Allocation$inboundSchema)).optional(),
    asset_id: z.string().optional(),
    bond_default: z.nullable(z.lazy(() => exports.BondDefault$inboundSchema))
        .optional(),
    ...
    cash_dividend: z.nullable(z.lazy(() => exports.CashDividend$inboundSchema))
        .optional(),
    cash_in_lieu: z.nullable(z.lazy(() => exports.CashInLieu$inboundSchema)).optional(),
    ...
    transfer: z.nullable(z.lazy(() => exports.EntryTransfer$inboundSchema)).optional(),
...
exports.Entry$outboundSchema = z.object({
    ...
    allocation: z.nullable(z.lazy(() => exports.Allocation$outboundSchema)).optional(),
    assetId: z.string().optional(),
    bondDefault: z.nullable(z.lazy(() => exports.BondDefault$outboundSchema)).optional(),
    ...
    cashDividend: z.nullable(z.lazy(() => exports.CashDividend$outboundSchema))
        .optional(),
    cashInLieu: z.nullable(z.lazy(() => exports.CashInLieu$outboundSchema)).optional(),
    ...
    transfer: z.nullable(z.lazy(() => exports.EntryTransfer$outboundSchema)).optional(),
