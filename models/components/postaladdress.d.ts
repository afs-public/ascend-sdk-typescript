...
export declare function postalAddressToJSON(postalAddress: PostalAddress): string;
export declare function postalAddressFromJSON(jsonString: string): SafeParseResult<PostalAddress, SDKValidationError>;
