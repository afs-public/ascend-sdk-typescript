...
export declare function iraSimpleEnrollmentMetadataCreateToJSON(iraSimpleEnrollmentMetadataCreate: IRASimpleEnrollmentMetadataCreate): string;
export declare function iraSimpleEnrollmentMetadataCreateFromJSON(jsonString: string): SafeParseResult<IRASimpleEnrollmentMetadataCreate, SDKValidationError>;
