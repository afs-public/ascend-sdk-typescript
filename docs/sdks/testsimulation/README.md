...
<!-- UsageSnippet language="typescript" operationID="WireDeposits_SimulateWireDeposit" method="post" path="/transfers/v1/accounts/{account_id}/wireDeposits:simulate" -->
```typescript
import { Apexascend } from "@apexfintechsolutions/ascend-sdk";
...
async function run() {
  const result = await apexascend.testSimulation.simulateWireDeposit({
    amount: {},
    parent: "accounts/01H8FB90ZRRFWXB4XC2JPJ1D4Y",
  }, "01H8FB90ZRRFWXB4XC2JPJ1D4Y");
...
```typescript
import { ApexascendCore } from "@apexfintechsolutions/ascend-sdk/core.js";
import { testSimulationSimulateWireDeposit } from "@apexfintechsolutions/ascend-sdk/funcs/testSimulationSimulateWireDeposit.js";
...
async function run() {
  const res = await testSimulationSimulateWireDeposit(apexascend, {
    amount: {},
    parent: "accounts/01H8FB90ZRRFWXB4XC2JPJ1D4Y",
  }, "01H8FB90ZRRFWXB4XC2JPJ1D4Y");
  if (res.ok) {
    ...
    console.log("testSimulationSimulateWireDeposit failed:", res.error);
  }
}
...
**Promise\<[operations.WireDepositsSimulateWireDepositResponse](../../models/operations/wiredepositssimulatewiredepositresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="WireDeposits_ForceApproveWireDeposit" method="post" path="/transfers/v1/accounts/{account_id}/wireDeposits/{wireDeposit_id}:forceApprove" -->
```typescript
import { Apexascend } from "@apexfintechsolutions/ascend-sdk";
...
async function run() {
  const result = await apexascend.testSimulation.forceApproveWireDeposit({
...
```typescript
import { ApexascendCore } from "@apexfintechsolutions/ascend-sdk/core.js";
import { testSimulationForceApproveWireDeposit } from "@apexfintechsolutions/ascend-sdk/funcs/testSimulationForceApproveWireDeposit.js";
...
async function run() {
  const res = await testSimulationForceApproveWireDeposit(apexascend, {
    name: "accounts/01H8FB90ZRRFWXB4XC2JPJ1D4Y/wireDeposits/20230817000319",
  }, "01H8FB90ZRRFWXB4XC2JPJ1D4Y", "20230817000319");
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("testSimulationForceApproveWireDeposit failed:", res.error);
  }
}
...
**Promise\<[operations.WireDepositsForceApproveWireDepositResponse](../../models/operations/wiredepositsforceapprovewiredepositresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="WireDeposits_ForceRejectWireDeposit" method="post" path="/transfers/v1/accounts/{account_id}/wireDeposits/{wireDeposit_id}:forceReject" -->
```typescript
import { Apexascend } from "@apexfintechsolutions/ascend-sdk";
...
async function run() {
  const result = await apexascend.testSimulation.forceRejectWireDeposit({
    name: "accounts/01H8FB90ZRRFWXB4XC2JPJ1D4Y/wireDeposits/20230817000319",
  }, "01H8FB90ZRRFWXB4XC2JPJ1D4Y", "20230817000319");
...
```typescript
import { ApexascendCore } from "@apexfintechsolutions/ascend-sdk/core.js";
import { testSimulationForceRejectWireDeposit } from "@apexfintechsolutions/ascend-sdk/funcs/testSimulationForceRejectWireDeposit.js";
...
async function run() {
  const res = await testSimulationForceRejectWireDeposit(apexascend, {
    name: "accounts/01H8FB90ZRRFWXB4XC2JPJ1D4Y/wireDeposits/20230817000319",
  }, "01H8FB90ZRRFWXB4XC2JPJ1D4Y", "20230817000319");
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("testSimulationForceRejectWireDeposit failed:", res.error);
  }
}
...
**Promise\<[operations.WireDepositsForceRejectWireDepositResponse](../../models/operations/wiredepositsforcerejectwiredepositresponse.md)\>**
