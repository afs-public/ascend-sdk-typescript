...
<!-- UsageSnippet language="typescript" operationID="Accounts_UpdateAccountGroup" method="put" path="/accounts/v1/accounts/{account_id}:updateAccountGroup" -->
```typescript
import { Apexascend } from "@apexfintechsolutions/ascend-sdk";
...
async function run() {
  const result = await apexascend.accountManagement.updateAccountGroup({}, "01HC3MAQ4DR9QN1V8MJ4CN1HMK");
...
```typescript
import { ApexascendCore } from "@apexfintechsolutions/ascend-sdk/core.js";
import { accountManagementUpdateAccountGroup } from "@apexfintechsolutions/ascend-sdk/funcs/accountManagementUpdateAccountGroup.js";
...
async function run() {
  const res = await accountManagementUpdateAccountGroup(apexascend, {}, "01HC3MAQ4DR9QN1V8MJ4CN1HMK");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("accountManagementUpdateAccountGroup failed:", res.error);
  }
}
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `accountId`                                                                                                                                                                    | *string*                                                                                                                                                                       | :heavy_check_mark:                                                                                                                                                             | The account id.                                                                                                                                                                | [object Object]                                                                                                                                                                |
| `updateAccountGroupRequestUpdate`                                                                                                                                              | [components.UpdateAccountGroupRequestUpdate](../../models/components/updateaccountgrouprequestupdate.md)                                                                       | :heavy_check_mark:                                                                                                                                                             | N/A                                                                                                                                                                            |                                                                                                                                                                                |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |                                                                                                                                                                                |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |                                                                                                                                                                                |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |                                                                                                                                                                                |
...
**Promise\<[operations.AccountsUpdateAccountGroupResponse](../../models/operations/accountsupdateaccountgroupresponse.md)\>**
...
| `updateMask`                                                                                                                                                                                                                                                                                   | *string*                                                                                                                                                                                                                                                                                       | :heavy_minus_sign:                                                                                                                                                                                                                                                                             | The list of fields to update. Updatable Fields  `given_name`  `middle_names`  `family_name`  `phone_number`  `email_address`  `mailing_address.region_code`  `mailing_address.postal_code`  `mailing_address.administrative_area`  `mailing_address.locality`  `mailing_address.address_lines` | [object Object]                                                                                                                                                                                                                                                                                |
| `options`                                                                                                                                                                                                                                                                                      | RequestOptions                                                                                                                                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                                                                                                                                          |                                                                                                                                                                                                                                                                                                |
| `options.fetchOptions`                                                                                                                                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                                                                                                                                        | :heavy_minus_sign:                                                                                                                                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed.                                                                                                                 |                                                                                                                                                                                                                                                                                                |
| `options.retries`                                                                                                                                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                                                                                                                                               |                                                                                                                                                                                                                                                                                                |
...
<!-- UsageSnippet language="typescript" operationID="Accounts_CreateNote" method="post" path="/accounts/v1/accounts/{account_id}/notes" -->
```typescript
import { Apexascend } from "@apexfintechsolutions/ascend-sdk";
...
async function run() {
  const result = await apexascend.accountManagement.createNote({
...
```typescript
import { ApexascendCore } from "@apexfintechsolutions/ascend-sdk/core.js";
import { accountManagementCreateNote } from "@apexfintechsolutions/ascend-sdk/funcs/accountManagementCreateNote.js";
...
async function run() {
  const res = await accountManagementCreateNote(apexascend, {
    content: "Customer requested account review",
  }, "01HC3MAQ4DR9QN1V8MJ4CN1HMK");
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("accountManagementCreateNote failed:", res.error);
  }
}
...
**Promise\<[operations.AccountsCreateNoteResponse](../../models/operations/accountscreatenoteresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="Accounts_ListNotes" method="get" path="/accounts/v1/accounts/{account_id}/notes" -->
```typescript
import { Apexascend } from "@apexfintechsolutions/ascend-sdk";
...
async function run() {
  const result = await apexascend.accountManagement.listNotes("01HC3MAQ4DR9QN1V8MJ4CN1HMK");
...
```typescript
import { ApexascendCore } from "@apexfintechsolutions/ascend-sdk/core.js";
import { accountManagementListNotes } from "@apexfintechsolutions/ascend-sdk/funcs/accountManagementListNotes.js";
...
async function run() {
  const res = await accountManagementListNotes(apexascend, "01HC3MAQ4DR9QN1V8MJ4CN1HMK");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("accountManagementListNotes failed:", res.error);
  }
}
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `accountId`                                                                                                                                                                    | *string*                                                                                                                                                                       | :heavy_check_mark:                                                                                                                                                             | The account id.                                                                                                                                                                | [object Object]                                                                                                                                                                |
| `pageSize`                                                                                                                                                                     | *number*                                                                                                                                                                       | :heavy_minus_sign:                                                                                                                                                             | The maximum number of notes to return. The service may return fewer than this value.                                                                                           | [object Object]                                                                                                                                                                |
| `pageToken`                                                                                                                                                                    | *string*                                                                                                                                                                       | :heavy_minus_sign:                                                                                                                                                             | A page token, received from a previous `ListNotes` call.                                                                                                                       | [object Object]                                                                                                                                                                |
| `orderBy`                                                                                                                                                                      | *string*                                                                                                                                                                       | :heavy_minus_sign:                                                                                                                                                             | The order in which notes are listed. Supported fields: `create_time`.                                                                                                          | [object Object]                                                                                                                                                                |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |                                                                                                                                                                                |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |                                                                                                                                                                                |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |                                                                                                                                                                                |
...
**Promise\<[operations.AccountsListNotesResponse](../../models/operations/accountslistnotesresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="Accounts_GetNote" method="get" path="/accounts/v1/accounts/{account_id}/notes/{note_id}" -->
```typescript
import { Apexascend } from "@apexfintechsolutions/ascend-sdk";
...
async function run() {
  const result = await apexascend.accountManagement.getNote("01HC3MAQ4DR9QN1V8MJ4CN1HMK", "8096110d-fb55-4f9d-b883-b84f0b70d3ea");
...
```typescript
import { ApexascendCore } from "@apexfintechsolutions/ascend-sdk/core.js";
import { accountManagementGetNote } from "@apexfintechsolutions/ascend-sdk/funcs/accountManagementGetNote.js";
...
async function run() {
  const res = await accountManagementGetNote(apexascend, "01HC3MAQ4DR9QN1V8MJ4CN1HMK", "8096110d-fb55-4f9d-b883-b84f0b70d3ea");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("accountManagementGetNote failed:", res.error);
  }
}
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `accountId`                                                                                                                                                                    | *string*                                                                                                                                                                       | :heavy_check_mark:                                                                                                                                                             | The account id.                                                                                                                                                                | [object Object]                                                                                                                                                                |
| `noteId`                                                                                                                                                                       | *string*                                                                                                                                                                       | :heavy_check_mark:                                                                                                                                                             | The note id.                                                                                                                                                                   | [object Object]                                                                                                                                                                |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |                                                                                                                                                                                |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |                                                                                                                                                                                |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |                                                                                                                                                                                |
...
**Promise\<[operations.AccountsGetNoteResponse](../../models/operations/accountsgetnoteresponse.md)\>**
