...
```typescript
import { AccountsCreateNoteResponse } from "@apexfintechsolutions/ascend-sdk/models/operations";

let value: AccountsCreateNoteResponse = {};
```
...
| `note`                                                                                                       | [components.Note](../../models/components/note.md)                                                           | :heavy_minus_sign:                                                                                           | OK                                                                                                           |
