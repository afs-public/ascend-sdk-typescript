...
```typescript
import { AccountsCreateLegalNaturalPersonResponse } from "@apexfintechsolutions/ascend-sdk/models/operations";

let value: AccountsCreateLegalNaturalPersonResponse = {
  httpMeta: {
