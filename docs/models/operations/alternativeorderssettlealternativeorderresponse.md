...
```typescript
import { AlternativeOrdersSettleAlternativeOrderResponse } from "@apexfintechsolutions/ascend-sdk/models/operations";

let value: AlternativeOrdersSettleAlternativeOrderResponse = {};
```
