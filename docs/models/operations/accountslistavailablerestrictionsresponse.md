...
```typescript
import { AccountsListAvailableRestrictionsResponse } from "@apexfintechsolutions/ascend-sdk/models/operations";

let value: AccountsListAvailableRestrictionsResponse = {};
```
