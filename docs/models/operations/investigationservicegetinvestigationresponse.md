...
```typescript
import { InvestigationServiceGetInvestigationResponse } from "@apexfintechsolutions/ascend-sdk/models/operations";

let value: InvestigationServiceGetInvestigationResponse = {
  httpMeta: {
