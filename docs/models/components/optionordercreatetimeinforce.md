...
```typescript
import { OptionOrderCreateTimeInForce } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: OptionOrderCreateTimeInForce = OptionOrderCreateTimeInForce.Day;
```
