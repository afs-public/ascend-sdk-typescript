...
```typescript
import { AccountTotalNetWorthRangeUsd } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: AccountTotalNetWorthRangeUsd =
  AccountTotalNetWorthRangeUsd.From100KTo200K;
```
