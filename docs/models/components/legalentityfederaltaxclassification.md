...
```typescript
import { LegalEntityFederalTaxClassification } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: LegalEntityFederalTaxClassification =
  LegalEntityFederalTaxClassification.CCorporation;
```
