...
```typescript
import { CustomerProfileUpdateAnnualIncomeRangeUsd } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: CustomerProfileUpdateAnnualIncomeRangeUsd =
  CustomerProfileUpdateAnnualIncomeRangeUsd.From100KTo200K;
```
