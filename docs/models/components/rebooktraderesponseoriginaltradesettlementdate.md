...
```typescript
import { RebookTradeResponseOriginalTradeSettlementDate } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: RebookTradeResponseOriginalTradeSettlementDate = {};
```
