...
```typescript
import { LLCEnrollmentMetadataCreateMoneyMarketFundSweep } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: LLCEnrollmentMetadataCreateMoneyMarketFundSweep =
  LLCEnrollmentMetadataCreateMoneyMarketFundSweep.MoneyMarketFundSweepEnroll;
```
