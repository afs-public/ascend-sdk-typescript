...
```typescript
import { RebookTradeResponseOriginalTradeLocalMarketTradeDate } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: RebookTradeResponseOriginalTradeLocalMarketTradeDate = {};
```
