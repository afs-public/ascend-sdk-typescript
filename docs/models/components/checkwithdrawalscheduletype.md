...
```typescript
import { CheckWithdrawalScheduleType } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: CheckWithdrawalScheduleType = CheckWithdrawalScheduleType.Normal;
```
