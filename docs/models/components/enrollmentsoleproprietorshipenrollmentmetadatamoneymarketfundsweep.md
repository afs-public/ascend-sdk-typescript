...
```typescript
import { EnrollmentSoleProprietorshipEnrollmentMetadataMoneyMarketFundSweep } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: EnrollmentSoleProprietorshipEnrollmentMetadataMoneyMarketFundSweep =
  EnrollmentSoleProprietorshipEnrollmentMetadataMoneyMarketFundSweep
