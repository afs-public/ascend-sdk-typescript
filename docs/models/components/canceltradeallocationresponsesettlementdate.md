...
```typescript
import { CancelTradeAllocationResponseSettlementDate } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: CancelTradeAllocationResponseSettlementDate = {};
```
