...
```typescript
import { OptionOrderSpecialReportingInstructions } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: OptionOrderSpecialReportingInstructions =
  OptionOrderSpecialReportingInstructions
