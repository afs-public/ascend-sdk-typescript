...
```typescript
import { OptionOrderCancelRejectedReason } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: OptionOrderCancelRejectedReason =
  OptionOrderCancelRejectedReason.TooLateToCancel;
```
