...
```typescript
import { SetExtraReportingDataResponseCumulativeNotionalValue } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: SetExtraReportingDataResponseCumulativeNotionalValue = {};
```
