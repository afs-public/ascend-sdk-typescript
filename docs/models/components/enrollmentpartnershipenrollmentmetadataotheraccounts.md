...
```typescript
import { EnrollmentPartnershipEnrollmentMetadataOtherAccounts } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: EnrollmentPartnershipEnrollmentMetadataOtherAccounts = {};
```
