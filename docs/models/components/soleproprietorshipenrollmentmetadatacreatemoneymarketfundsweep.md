...
```typescript
import { SoleProprietorshipEnrollmentMetadataCreateMoneyMarketFundSweep } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: SoleProprietorshipEnrollmentMetadataCreateMoneyMarketFundSweep =
  SoleProprietorshipEnrollmentMetadataCreateMoneyMarketFundSweep
