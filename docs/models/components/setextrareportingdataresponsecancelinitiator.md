...
```typescript
import { SetExtraReportingDataResponseCancelInitiator } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: SetExtraReportingDataResponseCancelInitiator =
  SetExtraReportingDataResponseCancelInitiator.Firm;
```
