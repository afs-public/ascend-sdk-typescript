...
```typescript
import { TrustEnrollmentMetadataCreateMoneyMarketFundSweep } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: TrustEnrollmentMetadataCreateMoneyMarketFundSweep =
  TrustEnrollmentMetadataCreateMoneyMarketFundSweep.MoneyMarketFundSweepEnroll;
```
