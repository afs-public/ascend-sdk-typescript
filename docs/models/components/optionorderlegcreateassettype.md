...
```typescript
import { OptionOrderLegCreateAssetType } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: OptionOrderLegCreateAssetType = OptionOrderLegCreateAssetType.Option;
```
