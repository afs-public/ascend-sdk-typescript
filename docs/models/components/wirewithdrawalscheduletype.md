...
```typescript
import { WireWithdrawalScheduleType } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: WireWithdrawalScheduleType = WireWithdrawalScheduleType.Normal;
```
