...
```typescript
import { RebookExecutionResponseCommissionAmount } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: RebookExecutionResponseCommissionAmount = {};
```
