...
```typescript
import { RebookTradeResponseLocalMarketTradeDate } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: RebookTradeResponseLocalMarketTradeDate = {};
```
