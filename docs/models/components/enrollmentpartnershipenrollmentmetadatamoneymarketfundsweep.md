...
```typescript
import { EnrollmentPartnershipEnrollmentMetadataMoneyMarketFundSweep } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: EnrollmentPartnershipEnrollmentMetadataMoneyMarketFundSweep =
  EnrollmentPartnershipEnrollmentMetadataMoneyMarketFundSweep
