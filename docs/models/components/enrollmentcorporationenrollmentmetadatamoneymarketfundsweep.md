...
```typescript
import { EnrollmentCorporationEnrollmentMetadataMoneyMarketFundSweep } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: EnrollmentCorporationEnrollmentMetadataMoneyMarketFundSweep =
  EnrollmentCorporationEnrollmentMetadataMoneyMarketFundSweep
