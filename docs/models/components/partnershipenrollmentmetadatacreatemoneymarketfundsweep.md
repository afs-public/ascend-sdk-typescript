...
```typescript
import { PartnershipEnrollmentMetadataCreateMoneyMarketFundSweep } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: PartnershipEnrollmentMetadataCreateMoneyMarketFundSweep =
  PartnershipEnrollmentMetadataCreateMoneyMarketFundSweep
