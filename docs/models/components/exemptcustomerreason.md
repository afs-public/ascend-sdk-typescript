...
```typescript
import { ExemptCustomerReason } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: ExemptCustomerReason = ExemptCustomerReason.NonBankListedEntity;
```
