...
```typescript
import { EnrollmentMoneyMarketFundSweep } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: EnrollmentMoneyMarketFundSweep =
  EnrollmentMoneyMarketFundSweep.MoneyMarketFundSweepEnroll;
```
