...
```typescript
import { RebookTradeAllocationResponseSettlementDate } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: RebookTradeAllocationResponseSettlementDate = {};
```
