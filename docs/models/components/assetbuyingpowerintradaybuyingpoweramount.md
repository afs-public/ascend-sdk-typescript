...
```typescript
import { AssetBuyingPowerIntradayBuyingPowerAmount } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: AssetBuyingPowerIntradayBuyingPowerAmount = {};
```
