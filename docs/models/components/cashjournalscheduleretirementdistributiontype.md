...
```typescript
import { CashJournalScheduleRetirementDistributionType } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: CashJournalScheduleRetirementDistributionType =
  CashJournalScheduleRetirementDistributionType.Normal;
```
