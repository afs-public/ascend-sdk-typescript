...
```typescript
import { PartyLegalNaturalPersonFirstBNoticeDate } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: PartyLegalNaturalPersonFirstBNoticeDate = {};
```
