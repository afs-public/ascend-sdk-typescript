...
```typescript
import { CancelExecutionResponsePrevailingMarketPrice } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: CancelExecutionResponsePrevailingMarketPrice = {};
```
