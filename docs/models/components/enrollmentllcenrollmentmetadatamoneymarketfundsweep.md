...
```typescript
import { EnrollmentLlcEnrollmentMetadataMoneyMarketFundSweep } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: EnrollmentLlcEnrollmentMetadataMoneyMarketFundSweep =
  EnrollmentLlcEnrollmentMetadataMoneyMarketFundSweep
