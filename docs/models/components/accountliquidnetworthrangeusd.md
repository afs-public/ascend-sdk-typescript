...
```typescript
import { AccountLiquidNetWorthRangeUsd } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: AccountLiquidNetWorthRangeUsd =
  AccountLiquidNetWorthRangeUsd.From100KTo200K;
```
