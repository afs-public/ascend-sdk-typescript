...
```typescript
import { OptionInstructionType } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: OptionInstructionType = OptionInstructionType.DoNotExercise;
```
