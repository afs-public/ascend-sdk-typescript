...
```typescript
import { RebookTradeAllocationResponseOriginalTradeAllocationSettlementDate } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: RebookTradeAllocationResponseOriginalTradeAllocationSettlementDate =
  {};
```
