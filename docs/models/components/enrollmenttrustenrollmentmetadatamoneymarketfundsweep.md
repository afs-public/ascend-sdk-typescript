...
```typescript
import { EnrollmentTrustEnrollmentMetadataMoneyMarketFundSweep } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: EnrollmentTrustEnrollmentMetadataMoneyMarketFundSweep =
  EnrollmentTrustEnrollmentMetadataMoneyMarketFundSweep
