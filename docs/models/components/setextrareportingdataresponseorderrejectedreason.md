...
```typescript
import { SetExtraReportingDataResponseOrderRejectedReason } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: SetExtraReportingDataResponseOrderRejectedReason =
  SetExtraReportingDataResponseOrderRejectedReason.BelowNotionalMinimum;
```
