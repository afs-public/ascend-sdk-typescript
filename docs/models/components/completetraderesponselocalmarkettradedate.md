...
```typescript
import { CompleteTradeResponseLocalMarketTradeDate } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: CompleteTradeResponseLocalMarketTradeDate = {};
```
