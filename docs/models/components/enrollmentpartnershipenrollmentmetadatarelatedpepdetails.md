...
```typescript
import { EnrollmentPartnershipEnrollmentMetadataRelatedPepDetails } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: EnrollmentPartnershipEnrollmentMetadataRelatedPepDetails = {};
```
