...
```typescript
import { CancelTradeAllocationResponseGrossAmount } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: CancelTradeAllocationResponseGrossAmount = {};
```
