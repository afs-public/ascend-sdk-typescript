...
```typescript
import { PartyRequestUpdateProxyDeliveryPreference } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: PartyRequestUpdateProxyDeliveryPreference =
  PartyRequestUpdateProxyDeliveryPreference.Digital;
```
