...
```typescript
import { CancelExecutionResponseCommissionAmount } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: CancelExecutionResponseCommissionAmount = {};
```
