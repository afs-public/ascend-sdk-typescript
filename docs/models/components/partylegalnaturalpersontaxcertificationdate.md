...
```typescript
import { PartyLegalNaturalPersonTaxCertificationDate } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: PartyLegalNaturalPersonTaxCertificationDate = {};
```
