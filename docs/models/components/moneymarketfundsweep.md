...
```typescript
import { MoneyMarketFundSweep } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: MoneyMarketFundSweep =
  MoneyMarketFundSweep.MoneyMarketFundSweepEnroll;
```
