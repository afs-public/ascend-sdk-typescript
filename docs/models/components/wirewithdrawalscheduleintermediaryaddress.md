...
```typescript
import { WireWithdrawalScheduleIntermediaryAddress } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: WireWithdrawalScheduleIntermediaryAddress = {};
```
