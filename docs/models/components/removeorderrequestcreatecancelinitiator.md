...
```typescript
import { RemoveOrderRequestCreateCancelInitiator } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: RemoveOrderRequestCreateCancelInitiator =
  RemoveOrderRequestCreateCancelInitiator.Firm;
```
