...
```typescript
import { EnrollmentPartnershipEnrollmentMetadataForeignBondTradingDetails } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: EnrollmentPartnershipEnrollmentMetadataForeignBondTradingDetails =
  {};
```
