...
```typescript
import { PartyRequestUpdateTaxDocumentDeliveryPreference } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: PartyRequestUpdateTaxDocumentDeliveryPreference =
  PartyRequestUpdateTaxDocumentDeliveryPreference.Digital;
```
