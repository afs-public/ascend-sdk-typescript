...
```typescript
import { CancelTradeResponseLocalMarketTradeDate } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: CancelTradeResponseLocalMarketTradeDate = {};
```
