...
```typescript
import { EnrollmentPartnershipEnrollmentMetadataPrimaryAccountActivityType } from "@apexfintechsolutions/ascend-sdk/models/components";

let value: EnrollmentPartnershipEnrollmentMetadataPrimaryAccountActivityType =
  EnrollmentPartnershipEnrollmentMetadataPrimaryAccountActivityType
    .ActiveTrading;
```
