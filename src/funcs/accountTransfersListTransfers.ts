 ...
 */
export function accountTransfersListTransfers(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AccountTransfersListTransfersRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.AccountTransfersListTransfersResponse$inboundSchema,
      { key: "ListTransfersResponse" },
    ),
