 ...
 */
export function scheduleTransfersUpdateCheckWithdrawalSchedule(
...
> {
  ...
  const body = encodeJSON("body", payload.CheckWithdrawalScheduleUpdate, {
    explode: true,
  });
  ...
  const context = {
    ...
    operationID: "CheckWithdrawalSchedules_UpdateCheckWithdrawalSchedule",
    oAuth2Scopes: [],
