 ...
 */
export function optionOrdersSetOptionExtraReportingData(
...
> {
  const input: operations.OptionOrderServiceSetOptionExtraReportingDataRequest =
    {
      setOptionExtraReportingDataRequestCreate:
        setOptionExtraReportingDataRequestCreate,
      accountId: accountId,
  ...
  const body = encodeJSON(
    "body",
    payload.SetOptionExtraReportingDataRequestCreate,
    { explode: true },
  );
  ...
  const context = {
    ...
    operationID: "OptionOrderService_SetOptionExtraReportingData",
    oAuth2Scopes: [],
