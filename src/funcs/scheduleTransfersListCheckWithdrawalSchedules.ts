 ...
 */
export function scheduleTransfersListCheckWithdrawalSchedules(
...
> {
  ...
  const context = {
    ...
    operationID: "CheckWithdrawalSchedules_ListCheckWithdrawalSchedules",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      ...
      { key: "ListCheckWithdrawalSchedulesResponse" },
    ),
