 ...
 */
export function basketOrdersRemoveOrders(
...
> {
  const input: operations.BasketOrdersServiceRemoveOrdersRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.BasketOrdersServiceRemoveOrdersRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.BasketOrdersServiceRemoveOrdersResponse$inboundSchema,
      { key: "RemoveOrdersResponse" },
    ),
