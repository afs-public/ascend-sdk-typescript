 ...
 */
export function scheduleTransfersCreateCheckWithdrawalSchedule(
...
> {
  ...
  const body = encodeJSON("body", payload.CheckWithdrawalScheduleCreate, {
    explode: true,
  });
  ...
  const context = {
    ...
    operationID: "CheckWithdrawalSchedules_CreateCheckWithdrawalSchedule",
    oAuth2Scopes: [],
