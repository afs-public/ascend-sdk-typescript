 ...
 */
export function optionOrdersCreateOptionOrder(
...
> {
  const input: operations.OptionOrderServiceCreateOptionOrderRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.OptionOrderServiceCreateOptionOrderRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON("body", payload.OptionOrderCreate, { explode: true });
  ...
  const path = pathToFunc("/trading/v1/accounts/{account_id}/optionOrders")(
    pathParams,
  );
  ...
  >(
    M.json(
      200,
      operations.OptionOrderServiceCreateOptionOrderResponse$inboundSchema,
      { key: "OptionOrder" },
    ),
