 ...
 */
export function alternativeInvestmentsListAlternativeInvestments(
...
> {
  const input:
    operations.AlternativeInvestmentsListAlternativeInvestmentsRequest = {
      assetId: assetId,
      pageSize: pageSize,
      pageToken: pageToken,
      filter: filter,
  ...
  >(
    M.json(
      ...
      { key: "ListAlternativeInvestmentsResponse" },
    ),
