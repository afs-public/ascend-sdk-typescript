 ...
 */
export function scheduleTransfersSearchCashJournalSchedules(
...
> {
  ...
  const path = pathToFunc("/transfers/v1/cashJournalSchedules:search")();
  ...
  const context = {
    ...
    operationID: "CashJournalSchedules_SearchCashJournalSchedules",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      ...
      { key: "SearchCashJournalSchedulesResponse" },
    ),
