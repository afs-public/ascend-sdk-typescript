 ...
 */
export function createOrderSetExtraReportingData(
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.OrderServiceSetExtraReportingDataRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.OrderServiceSetExtraReportingDataResponse$inboundSchema,
      { key: "Order" },
    ),
