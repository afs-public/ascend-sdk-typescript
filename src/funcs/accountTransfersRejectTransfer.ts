 ...
 */
export async function accountTransfersRejectTransfer(
  ...
  >
> {
  const input: operations.AccountTransfersRejectTransferRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.AccountTransfersRejectTransferRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.AccountTransfersRejectTransferResponse$inboundSchema,
      { key: "RejectTransferResponse" },
    ),
