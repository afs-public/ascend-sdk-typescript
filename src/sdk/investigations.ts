...
import { investigationsCreateIdentityLookup } from "../funcs/investigationsCreateIdentityLookup.js";
...
import { investigationsVerifyIdentityLookup } from "../funcs/investigationsVerifyIdentityLookup.js";
...
export class Investigations extends ClientSDK {
  ...
  async createIdentityLookup(
    ...
    correspondentId: string,
    options?: RequestOptions,
  ): Promise<operations.IdentityLookupServiceCreateIdentityLookupResponse> {
    return unwrapAsync(investigationsCreateIdentityLookup(
      this,
   ...
   */
  async verifyIdentityLookup(
    verifyIdentityLookupRequestCreate:
      components.VerifyIdentityLookupRequestCreate,
    correspondentId: string,
    identityLookupId: string,
    options?: RequestOptions,
  ): Promise<operations.IdentityLookupServiceVerifyIdentityLookupResponse> {
    return unwrapAsync(investigationsVerifyIdentityLookup(
      this,
      verifyIdentityLookupRequestCreate,
      correspondentId,
      identityLookupId,
