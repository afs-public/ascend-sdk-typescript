...
export async function create_account_transfer_id(account_id: string): Promise<string | undefined> {
  ...
  const result = await sdk.accountTransfers.createTransfer(request, correspondentId, account_id);
