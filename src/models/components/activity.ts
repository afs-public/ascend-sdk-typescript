 ...
 */
export enum ActivityAccountTransferType {
 ...
 * The type of asset movement being performed within the lifecycle of an account transfer process
 */
export type ActivityAccountTransferTypeOpen = OpenEnum<
  typeof ActivityAccountTransferType
>;
 ...
 * Trade capacity type
 */
export type ActivityCapacityOpen = OpenEnum<typeof ActivityCapacity>;

/**
 * Records the number of contracts exercised or assigned
 */
export type ActivityOptionContractQuantity = {
  /**
   * The decimal value, as a string; Refer to [Google’s Decimal type protocol buffer](https://github.com/googleapis/googleapis/blob/40203ca1880849480bbff7b8715491060bbccdf1/google/type/decimal.proto#L33) for details
   */
  value?: string | undefined;
...
export type ActivityAssignment = {
   ...
   * Trade capacity type
   */
  capacity?: ActivityCapacityOpen | undefined;
  /**
   ...
   * Records the number of contracts exercised or assigned
   */
  optionContractQuantity?: ActivityOptionContractQuantity | null | undefined;
  /**
 ...
 * Trade capacity type
 */
export enum ActivityExerciseCapacity {
  CapacityUnspecified = "CAPACITY_UNSPECIFIED",
  Agency = "AGENCY",
  Principal = "PRINCIPAL",
  Mixed = "MIXED",
 ...
 * Trade capacity type
 */
export type ActivityExerciseCapacityOpen = OpenEnum<
  typeof ActivityExerciseCapacity
>;

/**
 * Exercise type classification
 */
export enum ActivityExerciseType {
 ...
 * Exercise type classification
 */
export type ActivityExerciseTypeOpen = OpenEnum<typeof ActivityExerciseType>;

/**
 * Records the number of contracts exercised or assigned
 */
export type ActivityExerciseOptionContractQuantity = {
  /**
   * The decimal value, as a string; Refer to [Google’s Decimal type protocol buffer](https://github.com/googleapis/googleapis/blob/40203ca1880849480bbff7b8715491060bbccdf1/google/type/decimal.proto#L33) for details
   */
  value?: string | undefined;
...
export type ActivityExercise = {
   ...
   * Trade capacity type
   */
  capacity?: ActivityExerciseCapacityOpen | undefined;
  /**
   * Exercise type classification
   */
  exerciseType?: ActivityExerciseTypeOpen | undefined;
  /**
   * Records the asset_id of the option that was exercised or assigned
   */
  optionAssetId?: string | undefined;
 ...
 * Indicates whether the price of the underlying was above or below the strike price of the option
 */
export type ActivityMoneynessOpen = OpenEnum<typeof ActivityMoneyness>;
 ...
 */
export type ActivityExpiration = {
  /**
   ...
   * Indicates whether the price of the underlying was above or below the strike price of the option
   */
  moneyness?: ActivityMoneynessOpen | undefined;
};
 ...
 */
export type ActivityOptionAdjustment = {
  /**
 ...
 */
export enum ActivitySideModifier {
 ...
 */
export enum ActivityTenderOfferType {
 ...
 * the type of tender offer
 */
export type ActivityTenderOfferTypeOpen = OpenEnum<
  typeof ActivityTenderOfferType
>;
 ...
 */
export enum ActivityTradeBrokerCapacity {
  CapacityUnspecified = "CAPACITY_UNSPECIFIED",
  Agency = "AGENCY",
  Principal = "PRINCIPAL",
  Mixed = "MIXED",
 ...
 * Used to calculate broadridge blotter code
 */
export type ActivityTradeBrokerCapacityOpen = OpenEnum<
  typeof ActivityTradeBrokerCapacity
>;
 ...
 * The type of price adjustment being applied by the broker to the net price of the security
 */
export enum ActivityTradePriceAdjustmentType {
  PriceAdjustmentTypeUnspecified = "PRICE_ADJUSTMENT_TYPE_UNSPECIFIED",
  Markup = "MARKUP",
  Markdown = "MARKDOWN",
  SalesLoad = "SALES_LOAD",
 ...
 * The type of price adjustment being applied by the broker to the net price of the security
 */
export type ActivityTradePriceAdjustmentTypeOpen = OpenEnum<
  typeof ActivityTradePriceAdjustmentType
>;
...
export type Activity = {
   ...
   * When booked with a type of MOVEMENT, this subtype will remove an options position due to assignment. When booked with a type of TRADE, this subtype records the purchase/ sale of the underlying asset from the assignment of an options position
   */
  assignment?: ActivityAssignment | null | undefined;
  /**
   * Object containing metadata for bond defaults
   */
   ...
   * When booked with a type of MOVEMENT, this subtype will remove an options position due to exercise. When booked with a type of TRADE, this subtype records the purchase/ sale of the underlying asset from exercising an options position
   */
  exercise?: ActivityExercise | null | undefined;
  /**
   * Used to record the removal of positions in options assets that have reached or passed their expiration date and expired worthless
   */
  expiration?: ActivityExpiration | null | undefined;
  /**
   * Used to record Fees that have been assessed to account and capture details related to the fee
   */
   ...
   * Used to record the adjustment of an options position. Usually these adjustments are due to a corporate action event in the underlying asset, though in rare cases, the OCC may make adjustments for other reasons
   */
  optionAdjustment?: ActivityOptionAdjustment | null | undefined;
  /**
...
/** @internal */
export const ActivityAccountTransferType$inboundSchema: z.ZodType<
  ActivityAccountTransferTypeOpen,
  z.ZodTypeDef,
  unknown
> = z
  .union([
...
/** @internal */
export const ActivityAccountTransferType$outboundSchema: z.ZodType<
  ActivityAccountTransferTypeOpen,
  z.ZodTypeDef,
  ActivityAccountTransferTypeOpen
> = z.union([
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityAccountTransferType$ {
  /** @deprecated use `ActivityAccountTransferType$inboundSchema` instead. */
  export const inboundSchema = ActivityAccountTransferType$inboundSchema;
  /** @deprecated use `ActivityAccountTransferType$outboundSchema` instead. */
  export const outboundSchema = ActivityAccountTransferType$outboundSchema;
}
...
/** @internal */
export const ActivityFairMarketValue$inboundSchema: z.ZodType<
...
/** @internal */
export const ActivityFairMarketValue$outboundSchema: z.ZodType<
  ActivityFairMarketValue$Outbound,
  z.ZodTypeDef,
  ActivityFairMarketValue
> = z.object({
  value: z.string().optional(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityFairMarketValue$ {
  /** @deprecated use `ActivityFairMarketValue$inboundSchema` instead. */
  export const inboundSchema = ActivityFairMarketValue$inboundSchema;
  /** @deprecated use `ActivityFairMarketValue$outboundSchema` instead. */
  export const outboundSchema = ActivityFairMarketValue$outboundSchema;
  /** @deprecated use `ActivityFairMarketValue$Outbound` instead. */
  export type Outbound = ActivityFairMarketValue$Outbound;
}

export function activityFairMarketValueToJSON(
  activityFairMarketValue: ActivityFairMarketValue,
): string {
  return JSON.stringify(
    ActivityFairMarketValue$outboundSchema.parse(activityFairMarketValue),
  );
}

export function activityFairMarketValueFromJSON(
  jsonString: string,
): SafeParseResult<ActivityFairMarketValue, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ActivityFairMarketValue$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ActivityFairMarketValue' from JSON`,
  );
}

/** @internal */
export const ActivityFairMarketValueDate$inboundSchema: z.ZodType<
...
/** @internal */
export const ActivityFairMarketValueDate$outboundSchema: z.ZodType<
  ActivityFairMarketValueDate$Outbound,
  z.ZodTypeDef,
  ActivityFairMarketValueDate
> = z.object({
  day: z.number().int().optional(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityFairMarketValueDate$ {
  /** @deprecated use `ActivityFairMarketValueDate$inboundSchema` instead. */
  export const inboundSchema = ActivityFairMarketValueDate$inboundSchema;
  /** @deprecated use `ActivityFairMarketValueDate$outboundSchema` instead. */
  export const outboundSchema = ActivityFairMarketValueDate$outboundSchema;
  /** @deprecated use `ActivityFairMarketValueDate$Outbound` instead. */
  export type Outbound = ActivityFairMarketValueDate$Outbound;
}

export function activityFairMarketValueDateToJSON(
  activityFairMarketValueDate: ActivityFairMarketValueDate,
): string {
  return JSON.stringify(
    ActivityFairMarketValueDate$outboundSchema.parse(
      activityFairMarketValueDate,
    ),
  );
}

export function activityFairMarketValueDateFromJSON(
  jsonString: string,
): SafeParseResult<ActivityFairMarketValueDate, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ActivityFairMarketValueDate$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ActivityFairMarketValueDate' from JSON`,
  );
}
...
> = z.object({
  ...
  fair_market_value: z.nullable(
    z.lazy(() => ActivityFairMarketValue$inboundSchema),
  ).optional(),
  fair_market_value_date: z.nullable(
    z.lazy(() => ActivityFairMarketValueDate$inboundSchema),
  ).optional(),
...
> = z.object({
  ...
  fairMarketValue: z.nullable(
    z.lazy(() => ActivityFairMarketValue$outboundSchema),
  ).optional(),
  fairMarketValueDate: z.nullable(
    z.lazy(() => ActivityFairMarketValueDate$outboundSchema),
  ).optional(),
...
/** @internal */
export const ActivityAllocation$inboundSchema: z.ZodType<
  ActivityAllocation,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const ActivityAllocation$outboundSchema: z.ZodType<
  ActivityAllocation$Outbound,
  z.ZodTypeDef,
  ActivityAllocation
> = z.object({
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityAllocation$ {
  /** @deprecated use `ActivityAllocation$inboundSchema` instead. */
  export const inboundSchema = ActivityAllocation$inboundSchema;
  /** @deprecated use `ActivityAllocation$outboundSchema` instead. */
  export const outboundSchema = ActivityAllocation$outboundSchema;
...
/** @internal */
export const ActivityCapacity$inboundSchema: z.ZodType<
  ActivityCapacityOpen,
  z.ZodTypeDef,
  unknown
> = z
  .union([
    z.nativeEnum(ActivityCapacity),
    z.string().transform(catchUnrecognizedEnum),
  ]);

/** @internal */
export const ActivityCapacity$outboundSchema: z.ZodType<
  ActivityCapacityOpen,
  z.ZodTypeDef,
  ActivityCapacityOpen
> = z.union([
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityCapacity$ {
  /** @deprecated use `ActivityCapacity$inboundSchema` instead. */
  export const inboundSchema = ActivityCapacity$inboundSchema;
  /** @deprecated use `ActivityCapacity$outboundSchema` instead. */
  export const outboundSchema = ActivityCapacity$outboundSchema;
}

/** @internal */
export const ActivityOptionContractQuantity$inboundSchema: z.ZodType<
...
/** @internal */
export type ActivityOptionContractQuantity$Outbound = {
  value?: string | undefined;
};

/** @internal */
export const ActivityOptionContractQuantity$outboundSchema: z.ZodType<
  ActivityOptionContractQuantity$Outbound,
  z.ZodTypeDef,
  ActivityOptionContractQuantity
> = z.object({
  value: z.string().optional(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityOptionContractQuantity$ {
  /** @deprecated use `ActivityOptionContractQuantity$inboundSchema` instead. */
  export const inboundSchema = ActivityOptionContractQuantity$inboundSchema;
  /** @deprecated use `ActivityOptionContractQuantity$outboundSchema` instead. */
  export const outboundSchema = ActivityOptionContractQuantity$outboundSchema;
  /** @deprecated use `ActivityOptionContractQuantity$Outbound` instead. */
  export type Outbound = ActivityOptionContractQuantity$Outbound;
}

export function activityOptionContractQuantityToJSON(
  activityOptionContractQuantity: ActivityOptionContractQuantity,
): string {
  return JSON.stringify(
    ActivityOptionContractQuantity$outboundSchema.parse(
      activityOptionContractQuantity,
    ),
  );
}

export function activityOptionContractQuantityFromJSON(
  jsonString: string,
): SafeParseResult<ActivityOptionContractQuantity, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ActivityOptionContractQuantity$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ActivityOptionContractQuantity' from JSON`,
  );
}

/** @internal */
export const ActivityAssignment$inboundSchema: z.ZodType<
  ActivityAssignment,
  z.ZodTypeDef,
  unknown
> = z.object({
  capacity: ActivityCapacity$inboundSchema.optional(),
  option_asset_id: z.string().optional(),
  option_contract_quantity: z.nullable(
    z.lazy(() => ActivityOptionContractQuantity$inboundSchema),
  ).optional(),
...
/** @internal */
export type ActivityAssignment$Outbound = {
...
/** @internal */
export const ActivityAssignment$outboundSchema: z.ZodType<
  ActivityAssignment$Outbound,
  z.ZodTypeDef,
  ActivityAssignment
> = z.object({
  capacity: ActivityCapacity$outboundSchema.optional(),
  optionAssetId: z.string().optional(),
  optionContractQuantity: z.nullable(
    z.lazy(() => ActivityOptionContractQuantity$outboundSchema),
  ).optional(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityAssignment$ {
  /** @deprecated use `ActivityAssignment$inboundSchema` instead. */
  export const inboundSchema = ActivityAssignment$inboundSchema;
  /** @deprecated use `ActivityAssignment$outboundSchema` instead. */
  export const outboundSchema = ActivityAssignment$outboundSchema;
  /** @deprecated use `ActivityAssignment$Outbound` instead. */
  export type Outbound = ActivityAssignment$Outbound;
}

export function activityAssignmentToJSON(
  activityAssignment: ActivityAssignment,
): string {
  return JSON.stringify(
    ActivityAssignment$outboundSchema.parse(activityAssignment),
  );
}

export function activityAssignmentFromJSON(
  jsonString: string,
): SafeParseResult<ActivityAssignment, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ActivityAssignment$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ActivityAssignment' from JSON`,
  );
}
...
/** @internal */
export const ActivityBondDefaultQuantity$outboundSchema: z.ZodType<
  ActivityBondDefaultQuantity$Outbound,
  z.ZodTypeDef,
  ActivityBondDefaultQuantity
> = z.object({
  value: z.string().optional(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityBondDefaultQuantity$ {
  /** @deprecated use `ActivityBondDefaultQuantity$inboundSchema` instead. */
  export const inboundSchema = ActivityBondDefaultQuantity$inboundSchema;
...
/** @internal */
export const ActivityBondDefault$inboundSchema: z.ZodType<
  ActivityBondDefault,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const ActivityBondDefault$outboundSchema: z.ZodType<
  ActivityBondDefault$Outbound,
  z.ZodTypeDef,
  ActivityBondDefault
> = z.object({
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityBondDefault$ {
  /** @deprecated use `ActivityBondDefault$inboundSchema` instead. */
  export const inboundSchema = ActivityBondDefault$inboundSchema;
...
/** @internal */
export const ActivityCapitalGainsCorporateActionGeneralInformation$inboundSchema:
  z.ZodType<
    ActivityCapitalGainsCorporateActionGeneralInformation,
    z.ZodTypeDef,
    unknown
...
/** @internal */
export const ActivityCapitalGainsCorporateActionGeneralInformation$outboundSchema:
  z.ZodType<
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityCapitalGainsCorporateActionGeneralInformation$ {
  /** @deprecated use `ActivityCapitalGainsCorporateActionGeneralInformation$inboundSchema` instead. */
  export const inboundSchema =
    ActivityCapitalGainsCorporateActionGeneralInformation$inboundSchema;
  /** @deprecated use `ActivityCapitalGainsCorporateActionGeneralInformation$outboundSchema` instead. */
  export const outboundSchema =
    ActivityCapitalGainsCorporateActionGeneralInformation$outboundSchema;
...
/** @internal */
export const ActivityCapitalGainsPaymentDate$outboundSchema: z.ZodType<
  ActivityCapitalGainsPaymentDate$Outbound,
  z.ZodTypeDef,
  ActivityCapitalGainsPaymentDate
> = z.object({
  day: z.number().int().optional(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityCapitalGainsPaymentDate$ {
  /** @deprecated use `ActivityCapitalGainsPaymentDate$inboundSchema` instead. */
  export const inboundSchema = ActivityCapitalGainsPaymentDate$inboundSchema;
  /** @deprecated use `ActivityCapitalGainsPaymentDate$outboundSchema` instead. */
  export const outboundSchema = ActivityCapitalGainsPaymentDate$outboundSchema;
...
> = z.object({
  ...
  payment_date: z.nullable(
    z.lazy(() => ActivityCapitalGainsPaymentDate$inboundSchema),
  ).optional(),
...
> = z.object({
  ...
  paymentDate: z.nullable(
    z.lazy(() => ActivityCapitalGainsPaymentDate$outboundSchema),
  ).optional(),
  quantity: z.nullable(
...
/** @internal */
export const ActivityCashDividendCashRate$outboundSchema: z.ZodType<
  ActivityCashDividendCashRate$Outbound,
  z.ZodTypeDef,
  ActivityCashDividendCashRate
> = z.object({
  value: z.string().optional(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityCashDividendCashRate$ {
  /** @deprecated use `ActivityCashDividendCashRate$inboundSchema` instead. */
  export const inboundSchema = ActivityCashDividendCashRate$inboundSchema;
...
> = z.object({
  cash_rate: z.nullable(
    z.lazy(() => ActivityCashDividendCashRate$inboundSchema),
  ).optional(),
  corporate_action_general_information: z.nullable(
    z.lazy(() =>
      ActivityCashDividendCorporateActionGeneralInformation$inboundSchema
...
> = z.object({
  cashRate: z.nullable(
    z.lazy(() => ActivityCashDividendCashRate$outboundSchema),
  ).optional(),
  corporateActionGeneralInformation: z.nullable(
    z.lazy(() =>
      ActivityCashDividendCorporateActionGeneralInformation$outboundSchema
...
/** @internal */
export const ActivityCashInLieuCorporateActionGeneralInformation$outboundSchema:
  z.ZodType<
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityCashInLieuCorporateActionGeneralInformation$ {
  /** @deprecated use `ActivityCashInLieuCorporateActionGeneralInformation$inboundSchema` instead. */
  export const inboundSchema =
    ActivityCashInLieuCorporateActionGeneralInformation$inboundSchema;
  /** @deprecated use `ActivityCashInLieuCorporateActionGeneralInformation$outboundSchema` instead. */
  export const outboundSchema =
    ActivityCashInLieuCorporateActionGeneralInformation$outboundSchema;
...
/** @internal */
export const ActivityCashInLieu$outboundSchema: z.ZodType<
  ActivityCashInLieu$Outbound,
  z.ZodTypeDef,
  ActivityCashInLieu
> = z.object({
  corporateActionGeneralInformation: z.nullable(
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityCashInLieu$ {
  /** @deprecated use `ActivityCashInLieu$inboundSchema` instead. */
  export const inboundSchema = ActivityCashInLieu$inboundSchema;
  /** @deprecated use `ActivityCashInLieu$outboundSchema` instead. */
  export const outboundSchema = ActivityCashInLieu$outboundSchema;
...
/** @internal */
export const ActivityExerciseCapacity$inboundSchema: z.ZodType<
  ActivityExerciseCapacityOpen,
  z.ZodTypeDef,
  unknown
> = z
  .union([
    z.nativeEnum(ActivityExerciseCapacity),
    z.string().transform(catchUnrecognizedEnum),
  ]);

/** @internal */
export const ActivityExerciseCapacity$outboundSchema: z.ZodType<
  ActivityExerciseCapacityOpen,
  z.ZodTypeDef,
  ActivityExerciseCapacityOpen
> = z.union([
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityExerciseCapacity$ {
  /** @deprecated use `ActivityExerciseCapacity$inboundSchema` instead. */
  export const inboundSchema = ActivityExerciseCapacity$inboundSchema;
  /** @deprecated use `ActivityExerciseCapacity$outboundSchema` instead. */
  export const outboundSchema = ActivityExerciseCapacity$outboundSchema;
}

/** @internal */
export const ActivityExerciseType$inboundSchema: z.ZodType<
  ActivityExerciseTypeOpen,
  z.ZodTypeDef,
  unknown
> = z
  .union([
    z.nativeEnum(ActivityExerciseType),
    z.string().transform(catchUnrecognizedEnum),
  ]);

/** @internal */
export const ActivityExerciseType$outboundSchema: z.ZodType<
  ActivityExerciseTypeOpen,
  z.ZodTypeDef,
  ActivityExerciseTypeOpen
> = z.union([
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityExerciseType$ {
  /** @deprecated use `ActivityExerciseType$inboundSchema` instead. */
  export const inboundSchema = ActivityExerciseType$inboundSchema;
  /** @deprecated use `ActivityExerciseType$outboundSchema` instead. */
  export const outboundSchema = ActivityExerciseType$outboundSchema;
}

/** @internal */
export const ActivityExerciseOptionContractQuantity$inboundSchema: z.ZodType<
  ActivityExerciseOptionContractQuantity,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export type ActivityExerciseOptionContractQuantity$Outbound = {
  value?: string | undefined;
};

/** @internal */
export const ActivityExerciseOptionContractQuantity$outboundSchema: z.ZodType<
  ActivityExerciseOptionContractQuantity$Outbound,
  z.ZodTypeDef,
  ActivityExerciseOptionContractQuantity
> = z.object({
  value: z.string().optional(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityExerciseOptionContractQuantity$ {
  /** @deprecated use `ActivityExerciseOptionContractQuantity$inboundSchema` instead. */
  export const inboundSchema =
    ActivityExerciseOptionContractQuantity$inboundSchema;
  /** @deprecated use `ActivityExerciseOptionContractQuantity$outboundSchema` instead. */
  export const outboundSchema =
    ActivityExerciseOptionContractQuantity$outboundSchema;
  /** @deprecated use `ActivityExerciseOptionContractQuantity$Outbound` instead. */
  export type Outbound = ActivityExerciseOptionContractQuantity$Outbound;
}

export function activityExerciseOptionContractQuantityToJSON(
  activityExerciseOptionContractQuantity:
    ActivityExerciseOptionContractQuantity,
): string {
  return JSON.stringify(
    ActivityExerciseOptionContractQuantity$outboundSchema.parse(
      activityExerciseOptionContractQuantity,
    ),
  );
}

export function activityExerciseOptionContractQuantityFromJSON(
  jsonString: string,
): SafeParseResult<ActivityExerciseOptionContractQuantity, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      ActivityExerciseOptionContractQuantity$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ActivityExerciseOptionContractQuantity' from JSON`,
  );
}

/** @internal */
export const ActivityExercise$inboundSchema: z.ZodType<
  ActivityExercise,
  z.ZodTypeDef,
  unknown
> = z.object({
  capacity: ActivityExerciseCapacity$inboundSchema.optional(),
  exercise_type: ActivityExerciseType$inboundSchema.optional(),
  option_asset_id: z.string().optional(),
  option_contract_quantity: z.nullable(
    z.lazy(() => ActivityExerciseOptionContractQuantity$inboundSchema),
  ).optional(),
  option_description: z.string().optional(),
}).transform((v) => {
  return remap$(v, {
...
/** @internal */
export type ActivityExercise$Outbound = {
  capacity?: string | undefined;
...
/** @internal */
export const ActivityExercise$outboundSchema: z.ZodType<
  ActivityExercise$Outbound,
  z.ZodTypeDef,
  ActivityExercise
> = z.object({
  capacity: ActivityExerciseCapacity$outboundSchema.optional(),
  exerciseType: ActivityExerciseType$outboundSchema.optional(),
  optionAssetId: z.string().optional(),
  optionContractQuantity: z.nullable(
    z.lazy(() => ActivityExerciseOptionContractQuantity$outboundSchema),
  ).optional(),
  optionDescription: z.string().optional(),
}).transform((v) => {
  return remap$(v, {
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityExercise$ {
  /** @deprecated use `ActivityExercise$inboundSchema` instead. */
  export const inboundSchema = ActivityExercise$inboundSchema;
  /** @deprecated use `ActivityExercise$outboundSchema` instead. */
  export const outboundSchema = ActivityExercise$outboundSchema;
  /** @deprecated use `ActivityExercise$Outbound` instead. */
  export type Outbound = ActivityExercise$Outbound;
}

export function activityExerciseToJSON(
  activityExercise: ActivityExercise,
): string {
  return JSON.stringify(
    ActivityExercise$outboundSchema.parse(activityExercise),
  );
}

export function activityExerciseFromJSON(
  jsonString: string,
): SafeParseResult<ActivityExercise, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ActivityExercise$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ActivityExercise' from JSON`,
  );
}

/** @internal */
export const ActivityMoneyness$inboundSchema: z.ZodType<
  ActivityMoneynessOpen,
  z.ZodTypeDef,
  unknown
> = z
  .union([
    z.nativeEnum(ActivityMoneyness),
    z.string().transform(catchUnrecognizedEnum),
  ]);

/** @internal */
export const ActivityMoneyness$outboundSchema: z.ZodType<
  ActivityMoneynessOpen,
  z.ZodTypeDef,
  ActivityMoneynessOpen
> = z.union([
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityMoneyness$ {
  /** @deprecated use `ActivityMoneyness$inboundSchema` instead. */
  export const inboundSchema = ActivityMoneyness$inboundSchema;
  /** @deprecated use `ActivityMoneyness$outboundSchema` instead. */
  export const outboundSchema = ActivityMoneyness$outboundSchema;
}

/** @internal */
export const ActivityExpiration$inboundSchema: z.ZodType<
  ActivityExpiration,
  z.ZodTypeDef,
  unknown
> = z.object({
  do_not_exercise: z.boolean().optional(),
  moneyness: ActivityMoneyness$inboundSchema.optional(),
}).transform((v) => {
  return remap$(v, {
...
/** @internal */
export type ActivityExpiration$Outbound = {
  do_not_exercise?: boolean | undefined;
  moneyness?: string | undefined;
};

/** @internal */
export const ActivityExpiration$outboundSchema: z.ZodType<
  ActivityExpiration$Outbound,
  z.ZodTypeDef,
  ActivityExpiration
> = z.object({
  doNotExercise: z.boolean().optional(),
  moneyness: ActivityMoneyness$outboundSchema.optional(),
}).transform((v) => {
  return remap$(v, {
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityExpiration$ {
  /** @deprecated use `ActivityExpiration$inboundSchema` instead. */
  export const inboundSchema = ActivityExpiration$inboundSchema;
  /** @deprecated use `ActivityExpiration$outboundSchema` instead. */
  export const outboundSchema = ActivityExpiration$outboundSchema;
  /** @deprecated use `ActivityExpiration$Outbound` instead. */
  export type Outbound = ActivityExpiration$Outbound;
}

export function activityExpirationToJSON(
  activityExpiration: ActivityExpiration,
): string {
  return JSON.stringify(
    ActivityExpiration$outboundSchema.parse(activityExpiration),
  );
}

export function activityExpirationFromJSON(
  jsonString: string,
): SafeParseResult<ActivityExpiration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ActivityExpiration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ActivityExpiration' from JSON`,
  );
}
...
/** @internal */
export const ActivityOptionAdjustment$inboundSchema: z.ZodType<
...
/** @internal */
export type ActivityOptionAdjustment$Outbound = {
  disbursed_asset_id?: string | undefined;
...
/** @internal */
export const ActivityOptionAdjustment$outboundSchema: z.ZodType<
  ActivityOptionAdjustment$Outbound,
  z.ZodTypeDef,
  ActivityOptionAdjustment
> = z.object({
  disbursedAssetId: z.string().optional(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityOptionAdjustment$ {
  /** @deprecated use `ActivityOptionAdjustment$inboundSchema` instead. */
  export const inboundSchema = ActivityOptionAdjustment$inboundSchema;
  /** @deprecated use `ActivityOptionAdjustment$outboundSchema` instead. */
  export const outboundSchema = ActivityOptionAdjustment$outboundSchema;
  /** @deprecated use `ActivityOptionAdjustment$Outbound` instead. */
  export type Outbound = ActivityOptionAdjustment$Outbound;
}

export function activityOptionAdjustmentToJSON(
  activityOptionAdjustment: ActivityOptionAdjustment,
): string {
  return JSON.stringify(
    ActivityOptionAdjustment$outboundSchema.parse(activityOptionAdjustment),
  );
}

export function activityOptionAdjustmentFromJSON(
  jsonString: string,
): SafeParseResult<ActivityOptionAdjustment, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ActivityOptionAdjustment$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ActivityOptionAdjustment' from JSON`,
  );
}
...
/** @internal */
export const ActivitySideModifier$inboundSchema: z.ZodType<
  ActivitySideModifierOpen,
  z.ZodTypeDef,
  unknown
> = z
  .union([
...
/** @internal */
export const ActivitySideModifier$outboundSchema: z.ZodType<
  ActivitySideModifierOpen,
  z.ZodTypeDef,
  ActivitySideModifierOpen
> = z.union([
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivitySideModifier$ {
  /** @deprecated use `ActivitySideModifier$inboundSchema` instead. */
  export const inboundSchema = ActivitySideModifier$inboundSchema;
  /** @deprecated use `ActivitySideModifier$outboundSchema` instead. */
  export const outboundSchema = ActivitySideModifier$outboundSchema;
}
...
/** @internal */
export const ActivityTenderOfferType$inboundSchema: z.ZodType<
  ActivityTenderOfferTypeOpen,
  z.ZodTypeDef,
  unknown
> = z
  .union([
...
/** @internal */
export const ActivityTenderOfferType$outboundSchema: z.ZodType<
  ActivityTenderOfferTypeOpen,
  z.ZodTypeDef,
  ActivityTenderOfferTypeOpen
> = z.union([
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityTenderOfferType$ {
  /** @deprecated use `ActivityTenderOfferType$inboundSchema` instead. */
  export const inboundSchema = ActivityTenderOfferType$inboundSchema;
  /** @deprecated use `ActivityTenderOfferType$outboundSchema` instead. */
  export const outboundSchema = ActivityTenderOfferType$outboundSchema;
}
...
/** @internal */
export const ActivityTradeBrokerCapacity$outboundSchema: z.ZodType<
  ActivityTradeBrokerCapacityOpen,
  z.ZodTypeDef,
  ActivityTradeBrokerCapacityOpen
> = z.union([
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityTradeBrokerCapacity$ {
  /** @deprecated use `ActivityTradeBrokerCapacity$inboundSchema` instead. */
  export const inboundSchema = ActivityTradeBrokerCapacity$inboundSchema;
  /** @deprecated use `ActivityTradeBrokerCapacity$outboundSchema` instead. */
  export const outboundSchema = ActivityTradeBrokerCapacity$outboundSchema;
}

/** @internal */
export const ActivityTradePrevailingMarketPrice$inboundSchema: z.ZodType<
...
/** @internal */
export const ActivityTradePrevailingMarketPrice$outboundSchema: z.ZodType<
  ActivityTradePrevailingMarketPrice$Outbound,
  z.ZodTypeDef,
  ActivityTradePrevailingMarketPrice
> = z.object({
  value: z.string().optional(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityTradePrevailingMarketPrice$ {
  /** @deprecated use `ActivityTradePrevailingMarketPrice$inboundSchema` instead. */
  export const inboundSchema = ActivityTradePrevailingMarketPrice$inboundSchema;
  /** @deprecated use `ActivityTradePrevailingMarketPrice$outboundSchema` instead. */
  export const outboundSchema =
    ActivityTradePrevailingMarketPrice$outboundSchema;
...
/** @internal */
export const ActivityTradePriceAdjustmentAmount$outboundSchema: z.ZodType<
  ActivityTradePriceAdjustmentAmount$Outbound,
  z.ZodTypeDef,
  ActivityTradePriceAdjustmentAmount
> = z.object({
  value: z.string().optional(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityTradePriceAdjustmentAmount$ {
  /** @deprecated use `ActivityTradePriceAdjustmentAmount$inboundSchema` instead. */
  export const inboundSchema = ActivityTradePriceAdjustmentAmount$inboundSchema;
...
/** @internal */
export const ActivityTradePriceAdjustmentPercent$inboundSchema: z.ZodType<
  ActivityTradePriceAdjustmentPercent,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const ActivityTradePriceAdjustmentPercent$outboundSchema: z.ZodType<
  ActivityTradePriceAdjustmentPercent$Outbound,
  z.ZodTypeDef,
  ActivityTradePriceAdjustmentPercent
> = z.object({
  value: z.string().optional(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityTradePriceAdjustmentPercent$ {
  /** @deprecated use `ActivityTradePriceAdjustmentPercent$inboundSchema` instead. */
  export const inboundSchema =
    ActivityTradePriceAdjustmentPercent$inboundSchema;
...
/** @internal */
export const ActivityTradePriceAdjustmentType$inboundSchema: z.ZodType<
  ActivityTradePriceAdjustmentTypeOpen,
  z.ZodTypeDef,
  unknown
> = z
  .union([
...
/** @internal */
export const ActivityTradePriceAdjustmentType$outboundSchema: z.ZodType<
  ActivityTradePriceAdjustmentTypeOpen,
  z.ZodTypeDef,
  ActivityTradePriceAdjustmentTypeOpen
> = z.union([
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityTradePriceAdjustmentType$ {
  /** @deprecated use `ActivityTradePriceAdjustmentType$inboundSchema` instead. */
  export const inboundSchema = ActivityTradePriceAdjustmentType$inboundSchema;
  /** @deprecated use `ActivityTradePriceAdjustmentType$outboundSchema` instead. */
  export const outboundSchema = ActivityTradePriceAdjustmentType$outboundSchema;
}

/** @internal */
export const ActivityTradePriceAdjustmentRecord$inboundSchema: z.ZodType<
  ActivityTradePriceAdjustmentRecord,
  z.ZodTypeDef,
  unknown
> = z.object({
  price_adjustment_amount: z.nullable(
    z.lazy(() => ActivityTradePriceAdjustmentAmount$inboundSchema),
  ).optional(),
  price_adjustment_percent: z.nullable(
    z.lazy(() => ActivityTradePriceAdjustmentPercent$inboundSchema),
  ).optional(),
...
/** @internal */
export const ActivityTradePriceAdjustmentRecord$outboundSchema: z.ZodType<
  ActivityTradePriceAdjustmentRecord$Outbound,
  z.ZodTypeDef,
  ActivityTradePriceAdjustmentRecord
> = z.object({
  priceAdjustmentAmount: z.nullable(
    z.lazy(() => ActivityTradePriceAdjustmentAmount$outboundSchema),
  ).optional(),
  priceAdjustmentPercent: z.nullable(
    z.lazy(() => ActivityTradePriceAdjustmentPercent$outboundSchema),
  ).optional(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityTradePriceAdjustmentRecord$ {
  /** @deprecated use `ActivityTradePriceAdjustmentRecord$inboundSchema` instead. */
  export const inboundSchema = ActivityTradePriceAdjustmentRecord$inboundSchema;
...
> = z.object({
  ...
  prevailing_market_price: z.nullable(
    z.lazy(() => ActivityTradePrevailingMarketPrice$inboundSchema),
  ).optional(),
  price_adjustment_record: z.nullable(
    z.lazy(() => ActivityTradePriceAdjustmentRecord$inboundSchema),
  ).optional(),
...
> = z.object({
  ...
  prevailingMarketPrice: z.nullable(
    z.lazy(() => ActivityTradePrevailingMarketPrice$outboundSchema),
  ).optional(),
  priceAdjustmentRecord: z.nullable(
    z.lazy(() => ActivityTradePriceAdjustmentRecord$outboundSchema),
  ).optional(),
  route: z.string().optional(),
  specialInstructions: z.array(z.string()).optional(),
...
> = z.object({
  ...
  assignment: z.nullable(z.lazy(() => ActivityAssignment$inboundSchema))
    .optional(),
  ...
  exercise: z.nullable(z.lazy(() => ActivityExercise$inboundSchema)).optional(),
  expiration: z.nullable(z.lazy(() => ActivityExpiration$inboundSchema))
    .optional(),
  ...
  option_adjustment: z.nullable(
    z.lazy(() => ActivityOptionAdjustment$inboundSchema),
  ).optional(),
...
export type Activity$Outbound = {
  ...
  assignment?: ActivityAssignment$Outbound | null | undefined;
  ...
  exercise?: ActivityExercise$Outbound | null | undefined;
  expiration?: ActivityExpiration$Outbound | null | undefined;
  ...
  option_adjustment?: ActivityOptionAdjustment$Outbound | null | undefined;
...
> = z.object({
  ...
  assignment: z.nullable(z.lazy(() => ActivityAssignment$outboundSchema))
    .optional(),
  ...
  exchange: z.nullable(z.lazy(() => ActivityExchange$outboundSchema))
    .optional(),
  exercise: z.nullable(z.lazy(() => ActivityExercise$outboundSchema))
    .optional(),
  expiration: z.nullable(z.lazy(() => ActivityExpiration$outboundSchema))
    .optional(),
  ...
  optionAdjustment: z.nullable(
    z.lazy(() => ActivityOptionAdjustment$outboundSchema),
  ).optional(),
