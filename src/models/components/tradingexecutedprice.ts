 ...
 */
export enum TradingExecutedPriceType {
 ...
 * The type of this price, which must be PRICE_PER_UNIT for equity orders, or PERCENTAGE_OF_PAR for fixed income orders.
 */
export type TradingExecutedPriceTypeOpen = OpenEnum<
  typeof TradingExecutedPriceType
>;
...
/** @internal */
export const TradingExecutedPriceType$outboundSchema: z.ZodType<
  TradingExecutedPriceTypeOpen,
  z.ZodTypeDef,
  TradingExecutedPriceTypeOpen
> = z.union([
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace TradingExecutedPriceType$ {
  /** @deprecated use `TradingExecutedPriceType$inboundSchema` instead. */
  export const inboundSchema = TradingExecutedPriceType$inboundSchema;
  /** @deprecated use `TradingExecutedPriceType$outboundSchema` instead. */
  export const outboundSchema = TradingExecutedPriceType$outboundSchema;
}

/** @internal */
export const TradingExecutedPrice$inboundSchema: z.ZodType<
...
/** @internal */
export const TradingExecutedPrice$outboundSchema: z.ZodType<
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace TradingExecutedPrice$ {
  /** @deprecated use `TradingExecutedPrice$inboundSchema` instead. */
  export const inboundSchema = TradingExecutedPrice$inboundSchema;
